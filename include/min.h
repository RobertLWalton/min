...
// Date:	Wed Oct 27 15:55:53 EDT 2010
//
...
namespace min {
    ...
    void initialize
	( min::obj_vec_ptr & vp, const min::stub * s );
    void initialize
	( min::obj_vec_ptr & vp, min::gen v );
    void deinitialize
	( min::obj_vec_ptr & vp );
