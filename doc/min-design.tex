...
\begin{indpar}\begin{tabular}{r@{}l}
\verb|void min::| & \MINKEY{obj\_private\_flag\_of}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( min::gen object )| \\
    \end{tabular}
\LABEL{MIN::OBJ_PRIVATE_FLAG_OF} \\
\verb|void min::| & \MINKEY{obj\_public\_flag\_of}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( min::gen object )| \\
    \end{tabular}
\LABEL{MIN::OBJ_PUBLIC_FLAG_OF} \\
\end{tabular}\end{indpar}
...
\verb|void min::| & \MINKEY{set\_public\_flag\_of\REL}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( min::obj_vec_insptr & vp )| \\
    \end{tabular}
\LABEL{MIN::SET_PUBLIC_FLAG} \\
\end{tabular}\end{indpar}
...
by calling the {\tt min::\EOL obj\_\EOL publish\REL} function
(\pagref{MIN::OBJ_PUBLISH}).
...
by the {\tt min::\EOL obj\_\EOL publish\REL} function
(\pagref{MIN::OBJ_PUBLISH}).
