...
\verb|void min::|
    & \MINKEY{initialize}\verb| ( min::str_ptr & sp, min::gen v )|
\LABEL{MIN::INIT_OF_STR_PTR} \\[1ex]
...
\verb|const char      |
    & \ttkey{operator [ ]}\verb| ( min::str_ptr & sp, int index )|
...
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  ...
	  \verb|   min::gen v )|
\LABEL{MIN::INITIALIZE_LAB_PTR_OF_GEN} \\
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::lab_ptr & labp,|\ARGBREAK
	  \verb|   min::stub * s )|
\LABEL{MIN::INITIALIZE_LAB_PTR_OF_STUB} \\
\verb|void min::|
	& \MINKEY{deinitialize}\ARGBREAK
	  \verb| ( min::lab_ptr & labp )|
\LABEL{MIN::DEINITIALIZE_LAB_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|const T & min::|
...
functions on \pagref{MIN::VAR_OF_VEC_PTR}, and their equivalents on
...
\verb|(constructor) min::| & \MINKEY{vec\_ptr}\verb| vp ( min::gen v )|
\LABEL{MIN::VEC_PTR_OF_GEN} \\
\verb|(constructor) min::| & \MINKEY{vec\_ptr}%
       \verb| vp ( const min::stub * s )|
\LABEL{MIN::VEC_PTR_OF_STUB} \\
\verb|(constructor) min::| & \MINKEY{vec\_ptr}%
       \verb| vp ( void )|
\LABEL{MIN::VEC_PTR_OF_VOID} \\
\end{tabular}\end{indpar}
...
\verb|void min::|
    & \MINKEY{initialize}%
      ...
      \verb|   min::gen v )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_VEC_PTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::vec_ptr & vp,| \\
      \verb|   const min::stub * s )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_VEC_PTR_OF_STUB} \\
\verb|void min::|
    & \MINKEY{deinitialize} \verb| ( min::vec_ptr & vp )|
\LABEL{MIN::DEINIT_OF_VEC_PTR_OF_STUB} \\
\end{tabular}\end{indpar}
...
\verb|min::gen | & \MINKEY{var}%
    \verb| ( min::vec_ptr & vp, min::unsptr index )|
\LABEL{MIN::VAR_OF_VEC_PTR} \\
\verb|min::gen | & \MINKEY{hash}%
    \verb| ( min::vec_ptr & vp, min::unsptr index )|
\LABEL{MIN::HASH_OF_VEC_PTR} \\
\verb|min::gen | & \MINKEY{attr}%
    \verb| ( min::vec_ptr & vp, min::unsptr index )|
\LABEL{MIN::ATTR_OF_VEC_PTR} \\
\verb|min::gen | & \MINKEY{aux}%
    \verb| ( min::vec_ptr & vp, min::unsptr aux_pointer )|
\LABEL{MIN::AUX_OF_VEC_PTR} \\
...
A \minkey{updatable\_vec\_ptr} is like a \verb|min::vec_ptr|
...
\begin{indpar}[0.2in]\begin{tabular}{r@{}l}
\verb|(constructor) min::| & \MINKEY{updatable\_vec\_ptr}%
    \verb| vp ( min::gen v )|
\LABEL{MIN::UPDATABLE_VEC_PTR_OF_GEN} \\
\verb|(constructor) min::| & \MINKEY{updatable\_vec\_ptr}%
    \verb| vp ( min::stub * s )|
\LABEL{MIN::UPDATABLE_VEC_PTR_OF_STUB} \\
\verb|(constructor) min::| & \MINKEY{updatable\_vec\_ptr}%
    \verb| vp ( void )|
\LABEL{MIN::UPDATABLE_VEC_PTR_OF_VOID} \\
...
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::updatable_vec_ptr & vp,| \\
      \verb|   min::gen v )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_UPDATABLE_VEC_PTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::updatable_vec_ptr & vp,| \\
      \verb|   min::stub * s )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_UPDATABLE_VEC_PTR_OF_STUB} \\
\verb|void min::|
    & \MINKEY{deinitialize}%
      \verb| ( min::updatable_vec_ptr & vp )|
\LABEL{MIN::DEINIT_OF_UPDATABLE_VEC_PTR_OF_STUB} \\
\end{tabular}\end{indpar}
...
\verb|void min::| & \MINKEY{set\_var}%
      ...
      \verb|   min::gen value )| \\
      \end{tabular}
\LABEL{MIN::SET_VAR_OF_UPDATABLE_VEC_PTR} \\
\verb|void min::| & \MINKEY{set\_hash}%
      ...
      \verb|   min::gen value )| \\
      \end{tabular}
\LABEL{MIN::SET_HASH_OF_UPDATABLE_VEC_PTR} \\
\verb|void min::| & \MINKEY{set\_attr}%
      ...
      \verb|   min::gen value )| \\
      \end{tabular}
\LABEL{MIN::SET_ATTR_OF_UPDATABLE_VEC_PTR} \\
\verb|void min::| & \MINKEY{set\_aux}%
      ...
      \verb|   min::gen value )| \\
      \end{tabular}
\LABEL{MIN::SET_AUX_OF_UPDATABLE_VEC_PTR} \\
...
A \minkey{insertable\_vec\_ptr} is like a
...
\begin{indpar}[0.2in]\begin{tabular}{r@{}l}
\verb|(constructor) min::| & \MINKEY{insertable\_vec\_ptr}%
    \verb| vp ( min::gen v )|
\LABEL{MIN::INSERTABLE_VEC_PTR_OF_GEN} \\
\verb|(constructor) min::| & \MINKEY{insertable\_vec\_ptr}%
    \verb| vp ( min::stub * s )|
\LABEL{MIN::INSERTABLE_VEC_PTR_OF_STUB} \\
\verb|(constructor) min::| & \MINKEY{insertable\_vec\_ptr}%
    \verb| vp ( void )|
\LABEL{MIN::INSERTABLE_VEC_PTR_OF_VOID} \\
...
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::insertable_vec_ptr & vp,| \\
      \verb|   min::gen v )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_INSERTABLE_VEC_PTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::insertable_vec_ptr & vp,| \\
      \verb|   min::stub * s )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_INSERTABLE_VEC_PTR_OF_STUB} \\
\verb|void min::|
    & \MINKEY{deinitialize}%
      \verb| ( min::insertable_vec_ptr & vp )|
\LABEL{MIN::DEINIT_OF_INSERTABLE_VEC_PTR_OF_STUB} \\
\end{tabular}\end{indpar}
...
\verb|void min::| & \MINKEY{attr\_push}%
      ...
      \verb|   min::gen value )| \\
      \end{tabular}
\LABEL{MIN::ATTR_PUSH_OF_INSERTABLE_VEC_PTR} \\
\verb|void min::| & \MINKEY{attr\_push}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::insertable_vec_ptr & vp,| \\
      \verb|   const min::gen * p, min::unsptr n )| \\
      \end{tabular}
\LABEL{MIN::ATTR_PUSH_MULTIPLE_OF_INSERTABLE_VEC_PTR} \\
...
\verb|void min::| & \MINKEY{aux\_push}%
      ...
      \verb|   min::gen value )| \\
      \end{tabular}
\LABEL{MIN::AUX_PUSH_OF_INSERTABLE_VEC_PTR} \\
\verb|void min::| & \MINKEY{aux\_push}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::insertable_vec_ptr & vp,| \\
      \verb|   const min::gen * p, min::unsptr n )| \\
      \end{tabular}
\LABEL{MIN::AUX_PUSH_MULTIPLE_OF_INSERTABLE_VEC_PTR} \\
...
\verb|void min::| & \MINKEY{attr\_pop}%
      ...
      \verb|   min::gen & value )| \\
      \end{tabular}
\LABEL{MIN::ATTR_POP_OF_INSERTABLE_VEC_PTR} \\
\verb|void min::| & \MINKEY{attr\_pop}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::insertable_vec_ptr & vp,| \\
      \verb|   min::gen * p, min::unsptr n )| \\
      \end{tabular}
\LABEL{MIN::ATTR_POP_MULTIPLE_OF_INSERTABLE_VEC_PTR} \\
...
\verb|void min::| & \MINKEY{aux\_pop}%
      ...
      \verb|   min::gen & value )| \\
      \end{tabular}
\LABEL{MIN::AUX_POP_OF_INSERTABLE_VEC_PTR} \\
\verb|void min::| & \MINKEY{aux\_pop}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::insertable_vec_ptr & vp,| \\
      \verb|   min::gen * p, min::unsptr n )| \\
      \end{tabular}
\LABEL{MIN::AUX_POP_MULTIPLE_OF_INSERTABLE_VEC_PTR} \\
...
\verb|bool min::| & \MINKEY{resize\REL}%
      ...
      \verb|   min::unsptr unused_size )| \\
      \end{tabular}
\LABEL{MIN::RESIZE_UNUSED_OF_INSERTABLE_VEC_PTR} \\
\verb|void min::| & \MINKEY{resize\REL}%
      ...
      \end{tabular}
\LABEL{MIN::RESIZE_UNUSED_AND_VAR_OF_INSERTABLE_VEC_PTR} \\
...
(\pagref{MIN::UNUSED_SIZE_OF_VEC_PTR}).
...
\verb|const min::gen * & MUP::| & \MUPKEY{base}%
    \verb| ( min::vec_ptr & v )|
\LABEL{MUP::BASE_OF_VEC_PTR} \\
\verb|min::gen * & MUP::| & \MUPKEY{base}%
    \verb| ( min::updatable_vec_ptr & v )|
\LABEL{MUP::BASE_OF_UPDATABLE_VEC_PTR} \\

\end{tabular}\end{indpar}

\begin{indpar}[0.2in]\begin{tabular}{r@{}l}

\verb|min::stub * MUP::| & \MUPKEY{stub\_of}\verb| ( min::vec_ptr & vp )|
\LABEL{MUP::STUB_OF_VEC_PTR} \\
...
\verb|min::unsptr & MUP::| & \MUPKEY{unused\_offset\_of}\ARGBREAK
    \verb| ( min::insertable_vec_ptr & vp )|
\LABEL{MUP::UNUSED_OFFSET_OF_INSERTABLE_VEC_PTR} \\
\verb|min::unsptr & MUP::| & \MUPKEY{aux\_offset\_of}\ARGBREAK
    \verb| ( min::insertable_vec_ptr & vp )|
\LABEL{MUP::AUX_OFFSET_OF_INSERTABLE_VEC_PTR} \\
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|min::|
	& \MINKEY{list\_ptr}\verb| lp ( min::vec_ptr & vp )|
\LABEL{MIN::LIST_PTR_OF_VEC_PTR} \\
\verb|min::vec_ptr & min::|
	& \MINKEY{vec\_ptr\_of}\verb| ( min::list_ptr & lp )|
\LABEL{MIN::VEC_PTR_OF_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{start\_hash}%
...
\verb|min::gen min::|
	& \MINKEY{start\_copy}\ARGBREAK
	  \verb| ( min::list_ptr & lp,|\ARGBREAK
	  \verb|   const min::updatable_list_ptr & lp2 )|
\LABEL{MIN::START_LIST_PTR_COPY_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_copy}\ARGBREAK
	  \verb| ( min::list_ptr & lp,|\ARGBREAK
	  \verb|   const min::insertable_list_ptr & lp2 )|
\LABEL{MIN::START_LIST_PTR_COPY_OF_INSERTABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
...
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::list_ptr & lp,|\ARGBREAK
	  \verb|   const min::updatable_list_ptr & lp2 )|
\LABEL{MIN::START_LIST_PTR_SUBLIST_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::list_ptr & lp,|\ARGBREAK
	  \verb|   const min::insertable_list_ptr & lp2 )|
\LABEL{MIN::START_LIST_PTR_SUBLIST_OF_INSERTABLE_LIST_PTR} \\
\verb|min::gen min::|
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|min::|
	& \MINKEY{updatable\_list\_ptr} \verb|lp| \\
	& \verb|    ( min::updatable_vec_ptr & vp )|
\LABEL{MIN::UPDATABLE_LIST_PTR_OF_UPDATABLE_VEC_PTR} \\
\multicolumn{2}{@{}l}{\tt min::updatable\_vec\_ptr \&} \\
\verb|min::|
	& \MINKEY{vec\_ptr\_of} \\
	& \verb|    ( min::updatable_list_ptr & lp )|
\LABEL{MIN::VEC_PTR_OF_UPDATABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{start\_hash}%
	  ...
	  \verb|   min::unsptr index )|
	  \end{tabular}
\LABEL{MIN::START_HASH_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_attr}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::updatable_list_ptr & lp,| \\
	  \verb|   min::unsptr index )|
	  \end{tabular}
\LABEL{MIN::START_ATTR_OF_UPDATABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{start\_copy}\ARGBREAK
	  \verb| ( min::updatable_list_ptr & lp,|\ARGBREAK
	  \verb|   const min::updatable_list_ptr & lp2 )|
\LABEL{MIN::START_UPDATABLE_LIST_PTR_COPY_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_copy}\ARGBREAK
	  \verb| ( min::updatable_list_ptr & lp,|\ARGBREAK
	  \verb|   const min::insertable_list_ptr & lp2 )|
\LABEL{MIN::START_UPDATABLE_LIST_PTR_COPY_OF_INSERTABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::updatable_list_ptr & lp,|\ARGBREAK
	  \verb|   const min::list_ptr & lp2 )|
\LABEL{MIN::START_UPDATABLE_LIST_PTR_SUBLIST_OF_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::updatable_list_ptr & lp,|\ARGBREAK
	  \verb|   const min::updatable_list_ptr & lp2 )|
\LABEL{MIN::START_UPDATABLE_LIST_PTR_SUBLIST_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::updatable_list_ptr & lp,|\ARGBREAK
	  \verb|   const min::insertable_list_ptr & lp2 )|
\LABEL{MIN::START_UPDATABLE_LIST_PTR_SUBLIST_OF_INSERTABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::updatable_list_ptr & lp )|
\LABEL{MIN::START_SUBLIST_OF_UPDATABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{next}\verb| ( min::updatable_list_ptr & lp )|
\LABEL{MIN::NEXT_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{peek}\verb| ( min::updatable_list_ptr & lp )|
\LABEL{MIN::PEEK_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{current}\verb| ( min::updatable_list_ptr & lp )|
\LABEL{MIN::CURRENT_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{update\_refresh}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::updatable_list_ptr & lp )| \\
	  \end{tabular}
\LABEL{MIN::UPDATE_REFRESH_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{insert\_refresh}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::updatable_list_ptr & lp )| \\
	  \end{tabular}
\LABEL{MIN::INSERT_REFRESH_OF_UPDATABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::unsptr min::|
	& \MINKEY{hash\_size\_of}\verb| ( min::updatable_list_ptr & lp )|
\LABEL{MIN::HASH_SIZE_OF_UPDATABLE_LIST_PTR} \\
\verb|min::unsptr min::|
	& \MINKEY{attr\_size\_of}\verb| ( min::updatable_list_ptr & lp )|
\LABEL{MIN::ATTR_SIZE_OF_UPDATABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|void min::|
	& \MINKEY{update}%
	  ...
	  \verb|   min::gen value )| \\
	  \end{tabular}
\LABEL{MIN::UPDATE_OF_UPDATABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|min::|
	& \MINKEY{insertable\_list\_ptr} \verb|lp| \\
	& \verb|    ( min::insertable_vec_ptr & vp )|
\LABEL{MIN::INSERTABLE_LIST_PTR_OF_INSERTABLE_VEC_PTR} \\
\multicolumn{2}{@{}l}{\tt min::insertable\_vec\_ptr \&} \\
\verb|min::|
	& \MINKEY{vec\_ptr\_of} \\
	& \verb|    ( min::insertable_list_ptr & lp )|
\LABEL{MIN::VEC_PTR_OF_INSERTABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{start\_hash}%
	  ...
	  \verb|   min::unsptr index )|
	  \end{tabular}
\LABEL{MIN::START_HASH_OF_INSERTABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_attr}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::insertable_list_ptr & lp,| \\
	  \verb|   min::unsptr index )|
	  \end{tabular}
\LABEL{MIN::START_ATTR_OF_INSERTABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{start\_copy}\ARGBREAK
	  \verb| ( min::insertable_list_ptr & lp,|\ARGBREAK
	  \verb|   const min::insertable_list_ptr & lp2 )|
\LABEL{MIN::START_INSERTABLE_LIST_PTR_COPY_OF_INSERTABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::insertable_list_ptr & lp,|\ARGBREAK
	  \verb|   const min::list_ptr & lp2 )|
\LABEL{MIN::START_INSERTABLE_LIST_PTR_SUBLIST_OF_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::insertable_list_ptr & lp,|\ARGBREAK
	  \verb|   const min::updatable_list_ptr & lp2 )|
\LABEL{MIN::START_INSERTABLE_LIST_PTR_SUBLIST_OF_UPDATABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::insertable_list_ptr & lp,|\ARGBREAK
	  \verb|   const min::insertable_list_ptr & lp2 )|
\LABEL{MIN::START_INSERTABLE_LIST_PTR_SUBLIST_OF_INSERTABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{start\_sublist}\ARGBREAK
	  \verb| ( min::insertable_list_ptr & lp )|
\LABEL{MIN::START_SUBLIST_OF_INSERTABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{next}\verb| ( min::insertable_list_ptr & lp )|
\LABEL{MIN::NEXT_OF_INSERTABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{peek}\verb| ( min::insertable_list_ptr & lp )|
\LABEL{MIN::PEEK_OF_INSERTABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{current}\verb| ( min::insertable_list_ptr & lp )|
\LABEL{MIN::CURRENT_OF_INSERTABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{update\_refresh}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::insertable_list_ptr & lp )| \\
	  \end{tabular}
\LABEL{MIN::UPDATE_REFRESH_OF_INSERTABLE_LIST_PTR} \\
\verb|min::gen min::|
	& \MINKEY{insert\_refresh}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::insertable_list_ptr & lp )| \\
	  \end{tabular}
\LABEL{MIN::INSERT_REFRESH_OF_INSERTABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::unsptr min::|
	& \MINKEY{hash\_size\_of}\verb| ( min::insertable_list_ptr & lp )|
\LABEL{MIN::HASH_SIZE_OF_INSERTABLE_LIST_PTR} \\
\verb|min::unsptr min::|
	& \MINKEY{attr\_size\_of}\verb| ( min::insertable_list_ptr & lp )|
\LABEL{MIN::ATTR_SIZE_OF_INSERTABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|void min::|
	& \MINKEY{update}%
	  ...
	  \verb|   min::gen value )| \\
	  \end{tabular}
\LABEL{MIN::UPDATE_OF_INSERTABLE_LIST_PTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|bool min::|
...
\pagref{MIN::RESIZE_UNUSED_OF_INSERTABLE_VEC_PTR}).
...
\pagref{NO-SUPERFLUOUS-LIST}, {\tt MUP::insertable\_list\_ptr}'s keep
...
\begin{indpar}\begin{tabular}{r@{}l}
\verb|typedef MUP::|
	& \verb|list_ptr_type<min::vec_ptr>|\ARGBREAK
	  \verb|min::|\MINKEY{list\_ptr}\verb|;| \\
\verb|typedef MUP::|
	& \verb|list_ptr_type<min::updatable_vec_ptr>|\ARGBREAK
	  \verb|min::|\MINKEY{list\_updatable\_ptr}\verb|;| \\
\verb|typedef MUP::|
	& \verb|list_ptr_type<min::insertable_vec_ptr>|\ARGBREAK
	  \verb|min::|\MINKEY{list\_insertable\_ptr}\verb|;| \\
\end{tabular}\end{indpar}
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|MUP::|
	& \MUPKEY{attr\_ptr}\verb| ap ( min::vec_ptr & vp )|
\LABEL{MUP::ATTR_PTR_OF_VEC_PTR} \\
\verb|void min::|
	& \MINKEY{locate}%
	  \begin{tabular}[t]{@{}l@{}}
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|MUP::|
	& \MUPKEY{updatable\_attr\_ptr} \verb|ap|\ARGBREAK
	  \verb| ( min::updatable_vec_ptr & vp )|
\LABEL{MUP::UPDATABLE_ATTR_OF_UPDATABLE_VEC_PTR} \\
\verb|void min::|
	& \MINKEY{locate}\ARGBREAK
	  \verb| ( min::updatable_attr_ptr & ap,|\ARGBREAK
	  \verb|   min::gen name )|
...
\verb|void min::|
	& \MINKEY{relocate}\ARGBREAK
	  \verb| ( min::updatable_attr_ptr & ap )|
...
\verb|bool min::| & \MINKEY{test\_flag}\ARGBREAK
    \verb| ( min::updatable_attr_ptr wap,|\ARGBREAK
    \verb|   unsigned n )|
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|MUP::|
	& \MUPKEY{insertable\_attr\_ptr} \verb|ap|\ARGBREAK
	  \verb| ( min::insertable_vec_ptr & vp )|
\LABEL{MUP::INSERTABLE_ATTR_OF_INSERTABLE_VEC_PTR} \\
\verb|void min::|
	& \MINKEY{locate}\ARGBREAK
	  \verb| ( min::insertable_attr_ptr & ap,|\ARGBREAK
	  \verb|   min::gen name )|
...
\verb|void min::|
	& \MINKEY{relocate}\ARGBREAK
	  \verb| ( min::insertable_attr_ptr & ap )|
...
\verb|bool min::| & \MINKEY{test\_flag}\ARGBREAK
    \verb| ( min::insertable_attr_ptr wap,|\ARGBREAK
    \verb|   unsigned n )|
...
\LABEL{MIN::PACKED_VEC_PTR_[]} \\
\verb|const E | & \verb|pvp|\TTDKEY{end\_ptr}\verb|()|
...
\verb|E | & \verb|pvup[i]|
\LABEL{MIN::PACKED_VEC_UPDPTR_[]} \\
\verb|const E | & \verb|pvup|\TTDKEY{end\_ptr}\verb|()|
...
\verb|E | & \verb|pvip[i]|
\LABEL{MIN::PACKED_VEC_INSPTR_[]} \\
\verb|const E | & \verb|pvip|\TTDKEY{end\_ptr}\verb|()|
...
\verb|pvp->length|.  This member function is useful on rare occassions
...
\verb|(constructor) min::|
    & \MINKEY{updatable\_vec\_ptr} \verb|vp|\ARGBREAK
    \verb| ( min::gen v )|
\LABEL{MIN::UPDATABLE_VEC_PTR_OF_GEN} \\
\verb|(constructor) min::|
    & \MINKEY{updatable\_vec\_ptr} \verb|vp|\ARGBREAK%
...
\verb|void min::|
    & \MINKEY{initialize}\ARGBREAK
      \verb| ( min::updatable_vec_ptr & vp,|\ARGBREAK
      \verb|   min::gen v )|
\LABEL{MIN::INIT_OF_UPDATABLE_VEC_PTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}\ARGBREAK
...
\begin{TABULAR}{1.8in}
\verb|(constructor) min::|
    & \MINKEY{insertable\_vec\_ptr} \verb|vp|\ARGBREAK
    \verb| ( min::gen v )|
\LABEL{MIN::INSERTABLE_VEC_PTR_OF_GEN} \\
\verb|(constructor) min::|
    & \MINKEY{insertable\_vec\_ptr} \verb|vp|\ARGBREAK%
...
\verb|void min::|
    & \MINKEY{initialize}\ARGBREAK
      \verb| ( min::insertable_vec_ptr & vp,|\ARGBREAK
      \verb|   min::gen v )|
\LABEL{MIN::INIT_OF_INSERTABLE_VEC_PTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}\ARGBREAK
...
\begin{TABULAR}{1.6in}
(constructor)~\verb|min::|
	& \MINKEY{updatable\_list\_ptr} \verb|lp|\ARGBREAK
	  \verb| ( min::updatable_vec_ptr & vp )|
\LABEL{MIN::UPDATABLE_LIST_PTR_OF_UPDATABLE_VEC_PTR} \\
\multicolumn{2}{@{}l}{\tt min::updatable\_vec\_ptr \&} \\
\verb|min::|
...
\begin{TABULAR}{1.4in}
(constructor)~\verb|min::|
	& \MINKEY{insertable\_list\_ptr} \verb|lp|\ARGBREAK
	  \verb| ( min::insertable_vec_ptr & vp )|
\LABEL{MIN::INSERTABLE_LIST_PTR_OF_INSERTABLE_VEC_PTR} \\
\multicolumn{2}{@{}l}{\tt min::insertable\_vec\_ptr \&} \\
\verb|min::|
