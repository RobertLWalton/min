...
except that an \TT{.initiator} value may be
\TT{min::\EOL LOGICAL\_\EOL LINE()} and a
\TT{.terminator} value may be
\TT{min::\EOL INDENTED\_\EOL PARAGRAPH()}.
...
\TT{"<LF>"} printed with logical line compact format.
...
\verb|// Names of specials 0xFFFFFF - 0 .. 0xFFFFFF - 9 are:|\ARGBREAK
\verb|//     MISSING  NONE  ANY  MULTI_VALUED  UNDEFINED|\ARGBREAK
\verb|//     SUCCESS  FAILURE  ERROR|\ARGBREAK
