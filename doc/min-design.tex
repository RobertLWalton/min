...
Note that unlike vector pointers, you cannot downcast more capable
...
list start functions appears to the
...
function that may cause a relocation and/or reorganization of
the object pointed at, and if a reorganization occurs,
...
Also, as noted above, you can use {\tt min::\EOL set} to change
