...
\subsubsection{Protected Body References}
\label{PROTECTED-BODY-REFERENCES}

In addition there is a general body reference type
that references any type an element in any body associated with any stub:

\newcommand{\TARG}{\BRACKETED{T}}

\begin{indpar}\begin{tabular}{r@{}l}
\verb|(constructor) min::| & \MINKEY{ptr\TARG}\verb| p|\ARGBREAK
...
\verb|T |
    & \TTOMKEY{=}{=}{of {\tt min::ptr\TARG}}
      \verb|( min::ptr<T> & p, T value )|
\LABEL{MIN::=PTR_OF_T} \\
\verb|T |
    & \TTOMKEY{=}{=}{of {\tt min::ptr\TARG}}
      \verb|( min::ptr<T> & p, min::locatable_var<T> location )|
\LABEL{MIN::=PTR_OF_LOCATION} \\
\verb|T |
    & \TTOMKEY{=}{=}{of {\tt min::ptr\TARG}}
...
\begin{indpar}\begin{tabular}{r@{}l}
\verb|T |
    & \TTOMKEY{T}{{\tt T}}{of {\tt min::ptr\TARG}}
