...
as themselves, regardless of the setting of the display control.
...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(const min::ustring *) "\x03\x03" "{* "  // obj_valbegin|\ARGBREAK
\verb|(const min::ustring *) "\x02\x02" ", "   // obj_valsep|\ARGBREAK
\verb|(const min::ustring *) "\x03\x03" " *}"  // obj_valend|\ARGBREAK
...
Here what would be `{\em attribute-label} \TT{= TRUE}' is replaced by
