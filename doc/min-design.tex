...
The {\tt min::update\_\EOL refresh} function must be called for
...
A read-only {\tt min::\EOL raw\_\EOL vec\_\EOL pointer}
permits read-only access to raw vector elements.
An updatable {\tt min::\EOL updatable\_\EOL raw\_\EOL vec\_\EOL pointer}
permits read-write access to raw vector elements.
An insertable {\tt min::\EOL insertable\_\EOL raw\_\EOL vec\_\EOL pointer}
...
{\tt I} is a {\tt min::\EOL type\_\EOL info} structure descibed
at the end of this section that gives run-time information
needed to create and resize raw vectors.
...
\verb|rvp| is a raw vector pointer at the new vector,
...
maximum length of the raw vector pointed at, and the
...
are given by the {\tt type\_\EOL info} structure \verb|I|.
...
\verb|struct min::| & \MINKEY{raw\_vec\_type\_info}\ARGBREAK
    ...
    \verb|  const char *    signature;|\ARGBREAK
    ...
    \verb|};|
\ttmindex{name}{in {\tt min::raw\_vec\_type\_info}}
