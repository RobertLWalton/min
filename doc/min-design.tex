...
\begin{indpar}\begin{tabular}{p{1.5in}@{~~~}p{4.0in}}
\TT{min::IS\_SEPARATOR}	& The string is a \underline{strict} separator.
...
\verb|const min::uns32 min::| & \MINKEY{DISABLE\_BREAKS}
\LABEL{MIN::DISABLE_BREAKS_FLAG} \\
...
\verb|const min::op min::| & \MINKEY{disable\_breaks}
\LABEL{MIN::DISABLE_BREAKS} \\
\verb|const min::op min::| & \MINKEY{nodisable\_breaks}
\LABEL{MIN::NODISABLE_BREAKS} \\
