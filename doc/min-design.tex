...
{\em segment-sublists} and {\em map-sublists} are sublists.

A {\em value} is a list element, and is an {\em number}, {\em string},
{\em label}, {\em object}, or {\em index}.
...
a {\em flag-set}, and optionally a {\em map-sublist} that represents
the children of the node, and a {\em reverse-child-sublist}
that also represents a different kind of children of the node.

An attribute name corresponds
to the node reached from the root by going successively to the children
named by the {\em name-components} in the attribute name.
An element of the object's has table is a {\em hash-table-entry}
that is a {\em map-list} that lists the children of the root whose
{\em name-components} hash to the hash table element and are not
also legal attribute vector indices.  An element of the attribute vector
is the {\em segment-value} for a child of the root whose {\em name-component}
is the index of the element in the attribute vector.
...
{\em map-sublists} that are like {\em map-lists} and give more
...
may be ommitted from a {\em segment-sublist},
or just the {\em reverse-child-sublist} may be omitted.
If only one {\em map-sublist} is a omitted,
...
and reverse attribute names can be atoms or labels.  An atom is
