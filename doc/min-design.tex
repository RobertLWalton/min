...
An insertable {\tt min::\EOL vec\_\EOL insptr}
...
A \minkey{vec\_updptr} is like a \verb|min::vec_ptr|
...
\begin{indpar}[0.2in]\begin{tabular}{r@{}l}
\verb|(constructor) min::| & \MINKEY{vec\_updptr}%
    \verb| vp ( min::gen v )|
\LABEL{MIN::VEC_UPDPTR_OF_GEN} \\
\verb|(constructor) min::| & \MINKEY{vec\_updptr}%
    \verb| vp ( min::stub * s )|
\LABEL{MIN::VEC_UPDPTR_OF_STUB} \\
\verb|(constructor) min::| & \MINKEY{vec\_updptr}%
    \verb| vp ( void )|
\LABEL{MIN::VEC_UPDPTR_OF_VOID} \\
...
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::vec_updptr & vp,| \\
      \verb|   min::gen v )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_VEC_UPDPTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::vec_updptr & vp,| \\
      \verb|   min::stub * s )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_VEC_UPDPTR_OF_STUB} \\
\verb|void min::|
    & \MINKEY{deinitialize}%
      \verb| ( min::vec_updptr & vp )|
\LABEL{MIN::DEINIT_OF_VEC_UPDPTR_OF_STUB} \\
\end{tabular}\end{indpar}
...
A {\tt min::\EOL vec\_\EOL updptr} may be automatically
...
A \minkey{vec\_insptr} is like a
{\tt min::vec\_\EOL updptr}
...
\begin{indpar}[0.2in]\begin{tabular}{r@{}l}
\verb|(constructor) min::| & \MINKEY{vec\_insptr}%
    \verb| vp ( min::gen v )|
\LABEL{MIN::VEC_INSPTR_OF_GEN} \\
\verb|(constructor) min::| & \MINKEY{vec\_insptr}%
    \verb| vp ( min::stub * s )|
\LABEL{MIN::VEC_INSPTR_OF_STUB} \\
\verb|(constructor) min::| & \MINKEY{vec\_insptr}%
    \verb| vp ( void )|
\LABEL{MIN::VEC_INSPTR_OF_VOID} \\
...
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::vec_insptr & vp,| \\
      \verb|   min::gen v )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_VEC_INSPTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::vec_insptr & vp,| \\
      \verb|   min::stub * s )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_VEC_INSPTR_OF_STUB} \\
\verb|void min::|
    & \MINKEY{deinitialize}%
      \verb| ( min::vec_insptr & vp )|
\LABEL{MIN::DEINIT_OF_VEC_INSPTR_OF_STUB} \\
\end{tabular}\end{indpar}
...
A {\tt min::\EOL vec\_\EOL insptr} may be automatically
downcast to either a {\tt min::\EOL vec\_\EOL updptr}
or a {\tt min::\EOL vec\_\EOL ptr}.  This means that
all the non-constructor functions applicable to
{\tt min::\EOL vec\_\EOL updptr}'s or
{\tt min::\EOL vec\_\EOL ptr}'s are applicable to
{\tt min::\EOL vec\_\EOL insptr}'s.
Exceptions are destructors, the {\tt min::\EOL ini\-tial\-ize}
functions, and the {\tt min::\EOL de\-ini\-tial\-ize} functions, which
will suffer a {\tt MIN\_\EOL ASSERT} error if applied to a
downcast object vector pointer.
...
{\tt min::\EOL vec\_\EOL insptr} return an
...
{\tt min::\EOL vec\_\EOL insptr} may be
...
\multicolumn{2}{@{}l}{\tt min::vec\_updptr \&} \\
\verb|min::|
	& \MINKEY{vec\_ptr\_of} \\
	& \verb|    ( min::list_updptr & lp )|
\LABEL{MIN::VEC_PTR_OF_LIST_UPDPTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{start\_hash}%
...
\multicolumn{2}{@{}l}{\tt min::vec\_insptr \&} \\
\verb|min::|
	& \MINKEY{vec\_ptr\_of} \\
	& \verb|    ( min::list_insptr & lp )|
\LABEL{MIN::VEC_PTR_OF_LIST_INSPTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen min::|
	& \MINKEY{start\_hash}%
...
\verb|typedef MUP::|
	& \verb|list_ptr_type<min::vec_updptr>|\ARGBREAK
	  \verb|min::|\MINKEY{list\_updptr}\verb|;| \\
\verb|typedef MUP::|
	& \verb|list_ptr_type<min::vec_insptr>|\ARGBREAK
...
\verb|(constructor) min::|
    & \MINKEY{vec\_updptr} \verb|vp|\ARGBREAK
    \verb| ( min::gen v )|
\LABEL{MIN::VEC_UPDPTR_OF_GEN} \\
\verb|(constructor) min::|
    & \MINKEY{vec\_updptr} \verb|vp|\ARGBREAK%
...
\verb|void min::|
    & \MINKEY{initialize}\ARGBREAK
      \verb| ( min::vec_updptr & vp,|\ARGBREAK
      \verb|   min::gen v )|
\LABEL{MIN::INIT_OF_VEC_UPDPTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}\ARGBREAK
...
\begin{TABULAR}{1.8in}
\verb|(constructor) min::|
    & \MINKEY{vec\_insptr} \verb|vp|\ARGBREAK
    \verb| ( min::gen v )|
\LABEL{MIN::VEC_INSPTR_OF_GEN} \\
\verb|(constructor) min::|
    & \MINKEY{vec\_insptr} \verb|vp|\ARGBREAK%
...
\verb|void min::|
    & \MINKEY{initialize}\ARGBREAK
      \verb| ( min::vec_insptr & vp,|\ARGBREAK
      \verb|   min::gen v )|
\LABEL{MIN::INIT_OF_VEC_INSPTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}\ARGBREAK
