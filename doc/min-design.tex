...
When {\tt min::\EOL next\_\EOL line} returns {\tt min::\EOL NO\_\EOL LINE},
there may still be a non-NUL-terminated partial line\label{PARTIAL-LINE}
at the end of the file.
Bytes of this partial can be returned by the functions:
