...
classes that encapulate {\tt const min::\EOL stub~*} values are
...
body, you need to call an acc function to update garbage
...
You need to be able update stubs when locatable values are written
into the stubs or associated bodies.
