...
There are several list pointer information functions that can be useful:
...
\verb|unsigned min::|
	& \MINKEY{vector\_size\_of}\verb| ( min::list_pointer & lp )|
\LABEL{MIN::VECTOR_SIZE_OF_LIST_POINTER} \\
\verb|unsigned min::|
	& \MINKEY{hash\_size\_of}\verb| ( min::list_pointer & lp )|
\LABEL{MIN::HASH_SIZE_OF_LIST_POINTER} \\[1ex]
\verb|min::stub * min::|
	& \MINKEY{stub\_of}\verb| ( min::writable_list_pointer & lp )|
\LABEL{MIN::STUB_OF_LIST_POINTER_WRITABLE} \\
\verb|unsigned min::|
	& \MINKEY{vector\_size\_of}\verb| ( min::writable_list_pointer & lp )|
\LABEL{MIN::VECTOR_SIZE_OF_LIST_POINTER_WRITABLE} \\
\verb|unsigned min::|
	& \MINKEY{hash\_size\_of}\verb| ( min::writable_list_pointer & lp )|
\LABEL{MIN::HASH_SIZE_OF_LIST_POINTER_WRITABLE} \\[1ex]
\verb|min::stub * min::|
	& \MINKEY{stub\_of}\verb| ( min::insertable_list_pointer & lp )|
\LABEL{MIN::STUB_OF_LIST_POINTER_INSERTABLE} \\
\verb|unsigned min::|
	& \MINKEY{vector\_size\_of}\verb| ( min::insertable_list_pointer & lp )|
\LABEL{MIN::VECTOR_SIZE_OF_LIST_POINTER_INSERTABLE} \\
\verb|unsigned min::|
	& \MINKEY{hash\_size\_of}\verb| ( min::insertable_list_pointer & lp )|
\LABEL{MIN::HASH_SIZE_OF_LIST_POINTER_INSERTABLE} \\
\end{tabular}\end{center}

A pointer to the stub of the object
that a list pointer is associated with can be retrieved
by the {\tt min::stub\_of} function.  The size of the attribute vector
of this object can be retrieved by the {\tt vector\_size\_of} function,
and the size of the hash table can be retrieved by the {\tt hash\_size\_of}
function.
...
\LABEL{MIN::STUB_OF_LIST_POINTER_WRITABLE} \\
\verb|unsigned min::|
	& \MINKEY{vector\_size\_of}\ARGBREAK
	  \verb| ( min::writable_list_pointer & lp )|
\LABEL{MIN::VECTOR_SIZE_OF_LIST_POINTER_WRITABLE} \\
\verb|unsigned min::|
