...
Of these flags, only the first two:
...
some visible mark, and the \minkey{IS\_\EOL NON\_\EOL SPACING}
flag signifies that a character takes zero
columns, instead of 1 column.

The other flags are used by the printer context data and can
...
For \TT{min::standard\_char\_flags}, each character gets at least
