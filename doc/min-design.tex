...
These {\tt id\_map} flushing operations use {\tt min::\EOL pgen}
with the {\tt context\_\EOL gen\_\EOL flags[PGEN\_FLUSH]} flags
(\pagref{MIN::PGEN_FLUSH}) to print values in lines of the form:
\begin{center}
