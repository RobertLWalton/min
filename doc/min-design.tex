...
terminated by the value {\tt MUP::DISP\_END}\MUPindex{DISP\_END}.
...
This last means that when \verb|psp| is used as the left operand
of \verb|->| it is converted to a `\verb|const S *|' pointer and
similarly \verb|psup| is converted to a `\verb|S *|' pointer.
...
static min::uns32 ps_stub_ptr_disp[2] =
    { 12 + sizeof ( min::gen ), min::DISP_END };
