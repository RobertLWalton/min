...
(constructor)~\verb|min::|
	...
	& \verb|    ( min::updatable_vec_pointer & vp )|
\LABEL{MIN::UPDATABLE_LIST_POINTER_OF_VEC_POINTER} \\
...
The new value of the element may be {\tt min::\EOL EMPTY\_\EOL SUBLIST},
...
\verb|min::gen min::|
	& \MINKEY{start\_attr}%
	  ...
	  \verb|   min::uns32 index )|
	  \end{tabular}
\LABEL{MIN::START_ATTR_OF_INSERTABLE} \\
\verb|min::gen min::|
	& \MINKEY{start\_copy} \\
	& \verb|    ( min::insertable_list_pointer & lp,| \\
	& \verb|      const min::insertable_list_pointer & lp2 )|
...
\verb|min::uns32 MUP::|
	& \MUPKEY{attr\_size\_of}\verb| ( min::insertable_list_pointer & lp )|
\LABEL{MUP::ATTR_SIZE_OF_LIST_POINTER_OF_INSERTABLE} \\
\verb|min::gen MUP::|
	& \MUPKEY{start\_hash}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::insertable_list_pointer & lp,| \\
...
\verb|min::gen MUP::|
	& \MUPKEY{start\_attr}%
	  ...
	  \verb|   min::uns32 index )| \\
	  \end{tabular}
\LABEL{MUP::START_ATTR_OF_INSERTABLE} \\
\end{tabular}\end{indpar}
...
\LABEL{MUP::HASH_SIZE_OF_LIST_POINTER_OF_INSERTABLE} \\[1ex]
\verb|unsigned MUP::|
	& \MUPKEY{attr\_size\_of}\ARGBREAK
	  \verb| ( min::insertable_list_pointer & lp )|
\LABEL{MUP::ATTR_SIZE_OF_LIST_POINTER_OF_INSERTABLE} \\
\verb|min::gen MUP::|
