...
a VSIZE-bit indirect pair auxiliary pointer \\
a VSIZE/2-bit+VSIZE/2-bit indexed auxiliary pointer \\
a VSIZE-bit index \\
...
\verb|min::indexed_aux_of|, the \verb|min::index_of| function,
...
The {\tt unsigned} arguments used to make {\tt min::new\_indexed\_aux\_gen}
...
are chosen to aviod being the same as the high order bits of any
...
The following unprotected function can be used to replace the data
(non-subtype)
...
There are a few general value functions that accept any atom.
