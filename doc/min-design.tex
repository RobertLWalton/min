...
\newcommand{\ttarmkey}[2]{{\tt -\GREATERTHAN\bf #1}%
                          \index{#1@{\tt -\GREATERTHAN#1}!#2}}
...
(see Sections~\secref{PACKED-STRUCTURES} and \secref{PACKED-VECTORS})
must be locatable.
...
\verb|const min::stub * & min::| & \ttkey{operator [ ]}\ARGBREAK
...
and a packed structure (\secref{PACKED-STRUCTURES}) is:
...
See \secref{STUB-ALLOCATION-FUNCTIONS}.
...
\verb|const char      |
    & \ttkey{operator [ ]}\verb| ( const min::str_ptr & sp, int index )|
...
\LABEL{MIN::LAB_PTR_OF_VOID} \\
	& {\tt \bf operator const min::stub *}%
	  \index{min::stub@{\tt operator}!{\tt const min::stub *}}\ARGBREAK
...
written to {\tt printer}'s via the \verb|<<| operator, much like the
way values are written to {\tt std::\EOL ostream}'s.
...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|const min::uns32 prtr| & \TTARMKEY{length}{of min::printer}
\LABEL{MIN::PRINTER_LENGTH} \\
\verb|const min::uns32 prtr| & \TTARMKEY{line}{of min::printer}
\LABEL{MIN::PRINTER_LINE} \\
\verb|min::printer_state prtr| & \TTARMKEY{state}{of min::printer}
\LABEL{MIN::PRINTER_STATE} \\
\verb|min::printer_state prtr| & \TTARMKEY{saved\_state}{of min::printer}
\LABEL{MIN::PRINTER_SAVED_STATE} \\
\verb|std::ostream * prtr| & \TTARMKEY{ostream}{of min::printer}
\LABEL{MIN::PRINTER_OSTREAM} \\
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|struct min::| & \MINKEY{printer\_state}\ARGBREAK
    \verb|{|\ARGBREAK
    ...
    \verb|};|
\ttmindex{format}{in {\tt min::printer\_state}}
\ttmindex{column}{in {\tt min::printer\_state}}
\ttmindex{line\_length}{in {\tt min::printer\_state}}
\ttmindex{indent}{in {\tt min::printer\_state}}
\ttmindex{flags}{in {\tt min::printer\_state}}
\LABEL{MIN::PRINTER_STATE_STRUCT} \\
\end{tabular}\end{indpar}
...
\verb|const min::uns32 min::| & \MINNBKEY{DISPLAY\_LINEFEED\_FLAG}
\LABEL{MIN::DISPLAY_LINEFEED_FLAG} \\
\verb|const min::uns32 min::| & \MINNBKEY{HEX\_FLAG}
\LABEL{MIN::HEX_FLAG} \\
\verb|const min::uns32 min::| & \MINNBKEY{IGNORE\_LINE\_LENGTH\_FLAG}
\LABEL{MIN::IGNORE_LINE_LENGTH_FLAG} \\
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|struct min::| & \MINKEY{default\_printer\_state}\verb| =|\ARGBREAK
    \verb|{|\ARGBREAK
    \verb|  min::default_printer_format,     // format|\ARGBREAK
    \verb|  72,                              // line_length|\ARGBREAK
    \verb|  4,                               // indent|\ARGBREAK
    \verb|  0,                               // column|\ARGBREAK
    \verb|};|
\LABEL{MIN::DEFAULT_PRINTER_STATE}
\end{tabular}\end{indpar}
...
\verb|const min::printer_item min::|
    & \MINKEY{pgen}\verb| ( min::gen v,|\ARGBREAK
                   \verb| min::printer_format * = NULL )|
\LABEL{MIN::PGEN} \\
\verb|const min::printer_item min::|
...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|const min::printer_item min::|
    & \MINKEY{save\_printer\_state}
\LABEL{MIN::SAVE_PRINTER_STATE} \\
\verb|const min::printer_item min::|
    & \MINKEY{restore\_printer\_state}
\LABEL{MIN::RESTORE_PRINTER_STATE} \\
\verb|const min::printer_item min::| & \MINKEY{eol}
\LABEL{MIN::EOL} \\
\verb|const min::printer_item min::| & \MINKEY{eom}
\LABEL{MIN::EOM} \\
\verb|const min::printer_item min::| & \MINKEY{bom}
\LABEL{MIN::BOM} \\
\verb|const min::printer_item min::| & \MINKEY{hex}
\LABEL{MIN::HEX} \\
...
\LABEL{MIN::NOGRAPHIC} \\
\verb|const min::printer_item min::| & \MINKEY{display\_line\_feed}
\LABEL{MIN::DISPLAY_LINE_FEED} \\
\verb|const min::printer_item min::| & \MINKEY{nodisplay\_line\_feed}
\LABEL{MIN::NODISPLAY_LINE_FEED} \\
\verb|const min::printer_item min::| & \MINKEY{ignore\_line\_length}
\LABEL{MIN::IGNORE_LINE_LENGTH} \\
\verb|const min::printer_item min::| & \MINKEY{noignore\_line\_length}
\LABEL{MIN::NOIGNORE_LINE_LENGTH} \\
\end{tabular}\end{indpar}
...
\verb|min::printer & |
    & \TTKEY{operator \LESSTHAN\LESSTHAN}\\&{\tt ~~}
      \verb| ( min::printer & prtr, int32 i )|
\LABEL{PRINTER_OPERATOR<<_OF_INT32} \\
\verb|min::printer & |
    & \TTKEY{operator \LESSTHAN\LESSTHAN}\\&{\tt ~~}
      \verb| ( min::printer & prtr, int64 i )|
\LABEL{PRINTER_OPERATOR<<_OF_INT64} \\
\verb|min::printer & |
    & \TTKEY{operator \LESSTHAN\LESSTHAN}\\&{\tt ~~}
      \verb| ( min::printer & prtr, uns32 u )|
\LABEL{PRINTER_OPERATOR<<_OF_UNS32} \\
\verb|min::printer & |
    & \TTKEY{operator \LESSTHAN\LESSTHAN}\\&{\tt ~~}
      \verb| ( min::printer & prtr, uns64 u )|
...
(see Section~\secref{PACKED-VECTORS})
...
(see Section~\secref{STORING-GENERAL-VALUES}).  Any case,
...
See Section~\secref{PACKED-VECTORS} for a complete explanation of
...
\verb|min::obj_vec_ptr & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::obj_vec_ptr & vp, min::gen v )|
\LABEL{MIN::=_OBJ_VEC_PTR_OF_GEN} \\
\verb|min::obj_vec_ptr & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::obj_vec_ptr & vp, const min::stub * s )|
...
\verb|min::obj_vec_updptr & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::obj_vec_updptr & vp, min::gen v )|
\LABEL{MIN::=_OBJ_VEC_UPDPTR_OF_GEN} \\
\verb|min::obj_vec_updptr & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::obj_vec_updptr & vp, const min::stub * s )|
...
\verb|min::obj_vec_insptr & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::obj_vec_insptr & vp, min::gen v )|
\LABEL{MIN::=_OBJ_VEC_INSPTR_OF_GEN} \\
\verb|min::obj_vec_insptr & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::obj_vec_insptr & vp, const min::stub * s )|
...
\newcommand{\EARG}{\BRACKETED{E,H = min::packed\_vec\_header}}
...
and packed vector headers and elements (see \secref{PACKED-VECTORS}).
...
\verb|const min::stub * |
	& \verb|pstype.|\TTKEY{new\_stub} \verb|( void )|
\LABEL{PACKED_STRUCT_NEW_STUB} \\
\verb|min::uns32 |
	& \verb|pstype.|\TTMKEY{subtype}{in {\tt min::packed\_struct}}
...
\item[{\tt B}]
The C type of the base of {\tt S}, as indicated above.  Use
{\tt packed\_\EOL struct\_\EOL with\_\EOL base\BRACKETED{S,B}} if
{\tt B} is also the type of a packed structure body in order to
enable {\tt min::\EOL packed\_\EOL struct\_\EOL xxxptr<S>} pointers
to be converted to {\tt min::\EOL packed\_\EOL struct\_\EOL xxxptr<B>}
pointers.
...
structures created by {\tt pstype.new\_\EOL gen} or
...
\begin{indpar}\begin{tabular}{@{}l}
 \verb|min::packed_struct_ptr<S> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_struct_ptr<S> & psp, min::gen v )|
\LABEL{MIN::=_PACKED_STRUCT_PTR_OF_GEN} \\
\verb|min::packed_struct_ptr<S> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_struct_ptr<S> & psp, const min::stub * s )|
...
\begin{indpar}\begin{tabular}{@{}l}
 \verb|min::packed_struct_updptr<S> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_struct_updptr<S> & psup, min::gen v )|
\LABEL{MIN::=_PACKED_STRUCT_UPDPTR_OF_GEN} \\
\verb|min::packed_struct_updptr<S> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_struct_updptr<S> & psup, const min::stub * s )|
...
(constructor)~\verb|min::|
	& \MINKEY{packed\_vec\EARG} \verb|pvtype|\ARGBREAK
	  \verb| ( const char * name,|\ARGBREAK
...
\verb|const min::stub * |
	& \verb|pvtype.|\TTKEY{new\_stub} \verb|( void )|
...
\verb|const min::stub * |
	& \verb|pvtype.|\TTKEY{new\_stub}\ARGBREAK
	  \verb| ( min::uns32 max_length,|\ARGBREAK
	  \verb|   min::uns32 length = 0,|\ARGBREAK
	  \verb|   const E * vp = NULL )|
...
\verb|const min::uns32 * const pvtype| & \TTDMKEY{header\_stub\_ptr\_disp}
	                       {in {\tt min::packed\_vec}}
...
\verb|const min::uns32 * const pvtype| & \TTDMKEY{element\_stub\_ptr\_disp}
	                       {in {\tt min::packed\_vec}}
...
\item[{\tt B}]
The C type of the base of {\tt H}, as indicated above.  Use
{\tt packed\_\EOL vec\_\EOL with\_\EOL base\BRACKETED{E,H,B}} if
{\tt B} is also the type of a packed \underline{structure} body in order to
enable {\tt min::\EOL packed\_\EOL vec\_\EOL xxxptr<E,H>} pointers
to be converted to {\tt min::\EOL packed\_\EOL struct\_\EOL xxxptr<B>}
pointers.

Note that {\tt B} is treated as the type of the body of a packed
...
This is stored in the `{\tt control}' member of all packed
vectors created by {\tt pvtype.new\_\EOL gen} or
...
function with no arguments.  Defaults to \verb|1000|.
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|min::|
	& \MINKEY{packed\_vec\_ptr\EARG} \verb|pvp|\ARGBREAK
	  \verb| ( min::gen v )|
...
\begin{indpar}\begin{tabular}{@{}l}
 \verb|min::packed_vec_ptr<E,H> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_ptr<E,H> & pvp, min::gen v )|
\LABEL{MIN::=_PACKED_VEC_PTR_OF_GEN} \\
\verb|min::packed_vec_ptr<E,H> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_ptr<E,H> & pvp, const min::stub * s )|
...
\verb|const E pvp| & \TTMKEY{[i]}{of {\tt min::packed\_vec\_ptr}}
\LABEL{MIN::PACKED_VEC_PTR_[]} \\
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|min::|
	& \MINKEY{packed\_vec\_updptr\EARG} \verb|pvup|\ARGBREAK
	  \verb| ( min::gen v )|
...
\begin{indpar}\begin{tabular}{@{}l}
 \verb|min::packed_vec_updptr<E,H> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_updptr<E,H> & pvup, min::gen v )|
\LABEL{MIN::=_PACKED_VEC_UPDPTR_OF_GEN} \\
\verb|min::packed_vec_updptr<E,H> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_updptr<E,H> & pvup, const min::stub * s )|
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|min::|
	& \MINKEY{packed\_vec\_insptr\EARG} \verb|pvip|\ARGBREAK
	  \verb| ( min::gen v )|
...
\verb|min::packed_vec_insptr<E,H> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_insptr<E,H> & pvup, min::gen v )|
\LABEL{MIN::=_PACKED_VEC_INSPTR_OF_GEN} \\
\verb|min::packed_vec_insptr<E,H> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_insptr<E,H> & pvup, const min::stub * s )|
...
\newenvironment{TABULAR}[1]%
  ...
  {\end{tabular}}
\newenvironment{LONGTABULAR}%
  {\setlength{\TABULARLEN}{6.1in}
   \hspace*{0.10in}\begin{tabular}{@{}l@{}}
   \hspace*{\TABULARLEN} \\[-4ex]}%
  {\end{tabular}}
...
\begin{TABULAR}{2.4in}
\verb|const char * const |
	& \verb|pvtype.|\TTMKEY{subtype}{in {\tt min::packed\_vec}}
\LABEL{PACKED_VEC_SUBTYPE} \\
\verb|const char * const |
