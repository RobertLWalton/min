...
For 64-bit general values the high order 24 bits is used as a subtype
code.  The values chosen for this subtype code make direct strings,
pointers, auxilary pointers, and control codes into IEEE Nan (Not-a-Number)
...
24 bits of the value, and then replaces this retrieved value if the value
