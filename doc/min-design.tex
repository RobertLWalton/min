...
The number of the next line to be returned by the {\tt min::\EOL next\_EOL line}
...
next line to be returned by the {\tt min::\EOL next\_EOL line}
function.  I.e., that character is {\tt buffer[next\_EOL line\_\EOL offset]}.
...
\LABEL{MIN::ASCII} \\
\verb|const min::printer_op min::| & \MINKEY{noascii}
\LABEL{MIN::NOASCII} \\
