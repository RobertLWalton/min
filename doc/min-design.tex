...
A read-only {\tt min::\EOL obj\_\EOL vec\_\EOL ptr}
...
An insertable {\tt min::\EOL obj\_\EOL vec\_\EOL insptr}
...
\verb|void min::|
    & \MINKEY{initialize}%
      ...
      \verb|   min::gen v )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_OBJ_VEC_PTR_OF_GEN} \\
\verb|void min::|
    & \MINKEY{initialize}%
      \begin{tabular}[t]{@{}l@{}}
      \verb| ( min::obj_vec_ptr & vp,| \\
      \verb|   const min::stub * s )| \\
      \end{tabular}
\LABEL{MIN::INIT_OF_OBJ_VEC_PTR_OF_STUB} \\
\verb|void min::|
    & \MINKEY{deinitialize} \verb| ( min::obj_vec_ptr & vp )|
\LABEL{MIN::DEINIT_OF_OBJ_VEC_PTR_OF_STUB} \\
\end{tabular}\end{indpar}
