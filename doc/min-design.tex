...
the class {\tt min::\EOL packed\_\EOL struct\SARG} whose address
is used to identify the structure type \verb|S|.
{\tt PSID~* pstype.id} is this address.  Here \verb|PSID| denotes
an internally defined non-public type.
