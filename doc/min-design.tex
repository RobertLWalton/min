...
\verb|void min::|
    & \MINKEY{init\_output\_ostream}\ARGBREAK
	  ...
	  \verb|   min::gen filename = min::MISSING )|\ARGBREAK
...
\item[\ttmkey{length}{in {\tt min::file}}]
The number of {\tt char} elements in the file vector
...
\item[\ttmkey{column}{in {\tt min::file}}]
