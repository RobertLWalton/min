...
\item[\ttmkey{flags}{in {\tt min::gen\_format}}]
...
\item[\ttnbkey{OBJ\_PSTUB\_FLAG}]\vspace{-1ex}
...
\item[\ttnbmkey{OBJ\_PSTUB\_FLAG}{{\tt min::gen\_format} flag}]~\\
If set, TBD
...
\item[\ttmkey{str\_quote}{in {\tt min::gen\_format}}]
If not {\tt NULL}, then any {\tt min::gen} string
