...
A general value format is actually the closure of a function whose
address is the first member of the format.  This permits radically
different general value formats to be used, should they be
necessary.
