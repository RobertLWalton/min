...
is given an identifier by \TT{min::find\_\EOL or\_\EOL add}.  Objects
...
Also strings that would be printed as identifiers and which are
as long is the \ttikey{id\_\EOL strlen}{id\_strlen}
members of the \TT{min::\EOL str\_\EOL format} that would be used
to print them are given identifiers.  After all identifiers have
