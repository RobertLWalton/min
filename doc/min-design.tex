...
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::packed_vec<H,E>|\ARGBREAK
	  \verb|      ::updptr & pvup,|\ARGBREAK
	  \verb|   min::gen v )|
\LABEL{MIN::INITIALIZE_PACKED_VEC_UPDPTR_OF_GEN} \\
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::packed_vec<H,E>|\ARGBREAK
	  \verb|      ::updptr & pvup,|\ARGBREAK
	  \verb|   min::stub * s )|
\LABEL{MIN::INITIALIZE_PACKED_VEC_UPDPTR_OF_STUB} \\
\verb|void min::|
	& \MINKEY{deinitialize}\ARGBREAK
	  \verb| ( min::packed_vec<H,E>|\ARGBREAK
	  \verb|      ::updptr & pvup )|
\LABEL{MIN::DEINITIALIZE_PACKED_VEC_UPDPTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|min::|
...
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::packed_vec<H,E>|\ARGBREAK
	  \verb|      ::insptr & pvip,|\ARGBREAK
	  \verb|   min::gen v )|
\LABEL{MIN::INITIALIZE_PACKED_VEC_INSPTR_OF_GEN} \\
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::packed_vec<H,E>|\ARGBREAK
	  \verb|      ::insptr & pvip,|\ARGBREAK
	  \verb|   min::stub * s )|
\LABEL{MIN::INITIALIZE_PACKED_VEC_INSPTR_OF_STUB} \\
\verb|void min::|
	& \MINKEY{deinitialize}\ARGBREAK
	  \verb| ( min::packed_vec<H,E>|\ARGBREAK
	  \verb|      ::insptr & pvip )|
\LABEL{MIN::DEINITIALIZE_PACKED_VEC_INSPTR} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
...
\LABEL{MIN::PACKED_VEC_UPDPTR_MAX_LENGTH} \\
