...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(const min::ustring *) "\x82\x02" ": "   // obj_attrbegin|\ARGBREAK
...
`\TT{|T\}}' is replaced by `\TT{|\}}'.

Normal format is like compact format with no \TT{.initiator} except that if:
\begin{center}
\begin{tabular}{lcl}
...
\begin{center}
\begin{tabular}{rcl}
{\em attribute} & ::= & {\em attribute-label} \TT{=} {\em attribute-value} \\
		& $|$ & {\em attribute-label} \\
