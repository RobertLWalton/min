...
is essentually just a pointer to the string stub, which in turn points
...
\verb|unsigned min::| & \MUPKEY{length\_of}\verb| ( MUP::long_str * str )|
\LABEL{MUP::LENGTH_OF_LONG_STR} \\
\verb|unsigned min::| & \MUPKEY{hash\_of}\verb| ( MUP::long_str * str )|
