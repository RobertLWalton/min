...
is considered to be an upper case letter, while the other LATIN-1
...
\verb|'U'| & upper case letters; \verb|'A'| \ldots \verb|'Z'|,
                                 {\tt \`A} \ldots {\tt \'Y}. \\
\verb|'L'| & lower case letters; \verb|'a'| \dots \verb|'z'|,
                                 {\tt \`a} \ldots {\tt \"y}. \\
\end{tabular}
\end{center}
...
UNICODE character numeric value.  If the numeric value is a single
