...
as `Modified UTF-8' (\pagref{MODIFIED-UTF8}) encodings of UNICODE
character strings.  In these the NUL (zero) UNICODE 
\TT{min::Uchar} value is encoded as the 2 string bytes `\TT{0xC0,0x80}',
...
is called `\key{Modified UTF-8}\label{MODIFIED-UTF8}\index{UTF8!modified}'.
