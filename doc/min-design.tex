...
The new packed structure is set to all zeros.
...
\begin{indpar}\begin{tabular}{l@{~~~~~a.k.a~~~~~}l}
\verb|min::packed_vec_ptr<H,E>| & \verb|min::packed_vec<H,E>::ptr| \\
\verb|min::packed_vec_updptr<H,E>| & \verb|min::packed_vec<H,E>::updptr| \\
\verb|min::packed_vec_insptr<H,E>| & \verb|min::packed_vec<H,E>::insptr|
\end{tabular}\end{indpar}
...
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{@{}l}
 \verb|min::packed_vec_ptr<H,E> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_ptr<H,E> & pvp, min::gen v )|
\LABEL{MIN::=_PACKED_VEC_PTR_OF_GEN} \\
\verb|min::packed_vec_ptr<H,E> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_ptr<H,E> & pvp, const min::stub * s )|
\LABEL{MIN::=_PACKED_VEC_PTR_OF_STUB} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
	& {\tt \bf operator const min::stub *}%
	  \index{min::stub@{\tt operator}!{\tt const min::stub *}}\ARGBREAK
          \verb| ( const min::packed_vec_ptr<H,E> & pvp )|
...
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{@{}l}
 \verb|min::packed_vec_updptr<H,E> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_updptr<H,E> & pvup, min::gen v )|
\LABEL{MIN::=_PACKED_VEC_UPDPTR_OF_GEN} \\
\verb|min::packed_vec_updptr<H,E> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_updptr<H,E> & pvup, const min::stub * s )|
\LABEL{MIN::=_PACKED_VEC_UPDPTR_OF_STUB} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
	& {\tt \bf operator const min::stub *}%
	  \index{min::stub@{\tt operator}!{\tt const min::stub *}}\ARGBREAK
          \verb| ( const min::packed_vec_updptr<H,E> & pvup )|
\LABEL{MIN::PACKED_VEC_UPDPTR_TO_MIN_STUB} \\
\verb|H * | & \TTKEY{operator -\GREATERTHAN} \ARGBREAK
	  \verb| ( const min::packed_vec_updptr<H,E>|\ARGBREAK
	  \verb|      & pvup )|
...
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{@{}l}
\verb|min::packed_vec_insptr<H,E> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_insptr<H,E> & pvup, min::gen v )|
\LABEL{MIN::=_PACKED_VEC_INSPTR_OF_GEN} \\
\verb|min::packed_vec_insptr<H,E> & |
	  \TTKEY{operator =}\LONGARGBREAK
	  \verb| ( min::packed_vec_insptr<H,E> & pvup, const min::stub * s )|
\LABEL{MIN::=_PACKED_VEC_INSPTR_OF_STUB} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
	& {\tt \bf operator const min::stub *}%
	  \index{min::stub@{\tt operator}!{\tt const min::stub *}}\ARGBREAK
          \verb| ( const min::packed_vec_insptr<H,E> & pvip )|
\LABEL{MIN::PACKED_VEC_INSPTR_TO_MIN_STUB} \\
\verb|H * | & \TTKEY{operator -\GREATERTHAN} \ARGBREAK
	  \verb| ( const min::packed_vec_insptr<H,E>|\ARGBREAK
	  \verb|      & pvip )|
...
\verb|void min::|
	& \MINKEY{push} \ARGBREAK
	  \verb| ( packed_vec_insptr<H,E> pvip,| \ARGBREAK
	  \verb|   const E & v )|
...
\verb|E min::|
	& \MINKEY{pop} \ARGBREAK
	  \verb| ( packed_vec_insptr<H,E> pvip )|
