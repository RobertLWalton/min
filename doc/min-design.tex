...
At the \key{list level}, the body consists of two vectors whose
...
If the beginning of the list is \verb|min::LIST_END|, the list is
empty.
...
pointing at a sublist which equals the element, a list pointer pointing
at a continuation of the list, or \verb|min::LIST_END| indicating the
there is no element because the list ends.
