...
The 2-argument \TT{min::attr\_info\_of} function returns information
...
The 2-argument \TT{min::attr\_info\_of} function returns \TT{true} if
any of the 3 counts is non-zero, and \TT{false} otherwise.

The 3-argument \TT{min::attr\_info\_of} function returns in the
...
by the 3-argument \TT{min::\EOL attr\_\EOL info\_\EOL of} function unless
