...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{const min::str\_format *
    min::\MINKEY{quote\_first\_not\_letter\_str\_format}:}\ARGBREAK
...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{const min::str\_format *
                   min::\MINKEY{quote\_non\_graphic\_str\_format}:}\ARGBREAK
...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::quote\_control
		   min::\MINKEY{quote\_first\_not\_letter\_control}:}\ARGBREAK
...
The following function is called when a string \TT{min::gen} value
is printed, and can be used to print a \TT{const char *}
value according to the above formats:
...
You can also print a single unquoted \TT{min::Uchar} with:
...
Printing \TT{min::gen} values that are objects is complex and
...
\label{PRINTING-OTHER-OBJECT-VALUES}
...
\multicolumn{2}{l}{\tt struct
    ...
    \verb|{|\ARGBREAK
    \verb|  min::lab_format                      name_format;|%
...
\ARGBREAK
    \verb|  const min::ustring *                 obj_prefix;|%
\ttmindex{obj\_prefix}{in {\tt min::obj\_format}}\ARGBREAK
    \verb|  const min::ustring *                 obj_separator;|%
\ttmindex{obj\_separator}{in {\tt min::obj\_format}}\ARGBREAK
    \verb|  const min::ustring *                 obj_midfix;|%
\ttmindex{obj\_midfix}{in {\tt min::obj\_format}}\ARGBREAK
    \verb|  const min::ustring *                 obj_postfix;|%
\ttmindex{obj\_postfix}{in {\tt min::obj\_format}}\ARGBREAK
\ARGBREAK
    \verb|  const min::ustring *                 implicit_prefix;|%
\ttmindex{implicit\_prefix}{in {\tt min::obj\_format}}\ARGBREAK
    \verb|  const min::ustring *                 implicit_postfix;|%
\ttmindex{implicit\_postfix}{in {\tt min::obj\_format}}\ARGBREAK
\ARGBREAK
    \verb|  min::packed_vec_ptr<min::gen>        exp_ok_attr;|%
\ttmindex{exp\_ok\_attr}{in {\tt min::obj\_format}}\ARGBREAK
...
\verb|min::name_lab_format                     // name_format|\ARGBREAK
...
\verb|(const min::ustring *) "\x01\x41" "{"    // obj_prefix|\ARGBREAK
\verb|(const min::ustring *) "\x01\x81" ","    // obj_separator|\ARGBREAK
\verb$(const min::ustring *) "\x01\xC1" "|"    // obj_midfix$\ARGBREAK
\verb|(const min::ustring *) "\x01\x81" "}"    // obj_postfix|\ARGBREAK
\ARGBREAK
\verb$(const min::ustring *) "\x02\x42" "{|"   // implicit_prefix$\ARGBREAK
\verb$(const min::ustring *) "\x02\x82" "|}"   // implicit_postfix$\ARGBREAK
\ARGBREAK
\verb|min::standard_exp_ok_attr                // exp_ok_attr|\ARGBREAK
...
\verb|min::packed_vec_ptr<min::gen> min::|%
    \MINKEY{standard\_\EOL exp\_\EOL ok\_\EOL attrs}
\LABEL{MIN::STANDARD_EXP_OK_ATTRS} \\
\verb|    // 2 element (first element ".") min::gen labels for:| \\
\verb|    //     .initiator, .separator, .terminator, .middle, .name,| \\
\verb|    //     .arguments, .keys, .operator, .position, .type|
\end{tabular}\end{indpar}
...
\begin{TABULAR}{0.1in}
\multicolumn{2}{l}{const min::str\_format *
    min::\MINKEY{quote\_first\_not\_letter\_str\_format}:}
