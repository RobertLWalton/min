...
elements are printed, and the output has the form of an expression that
can be parsed.  This inverts the parsing process.

TBD

If the {\tt DATA\_EOL FLAG} is set, output of an object has the
form
