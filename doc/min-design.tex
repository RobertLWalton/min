...
But there is a better way to print error messages
if the positions of the erroneous text in the file
...
Here \verb|line| is the line number, \verb|offset| it the
...
Then in place of the above \verb|for| loop with its calls
