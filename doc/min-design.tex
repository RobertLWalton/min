...
\TT{xx}		& \TT{AC} & \TT{-,} & Not Sign \\
\TT{xx}		& \TT{AD} & \TT{--<space>} & Soft Hypen \\
\TT{\textregistered}
  & \TT{AE} & \TT{or} & Registered Sign \\
\TT{xx}		& \TT{AF} & \TT{\textasciicircum-} & Macron \\
\TT{\textdegree}		& \TT{B0} & \TT{oo} & Degree Sign \\
\TT{xx}		& \TT{B1} & \TT{+-} & Plus-Minus Sign \\
...
\TT{xx}		& \TT{B7} & \TT{\textasciicircum.} & Middle Dot \\
...
\begin{center}
\begin{tabular}{llll}
\TT{xx}		& \TT{D0} & \TT{DH} & Latin Capital Letter ETH \\
...
\TT{xx}		& \TT{D7} & \TT{xx} & Multiplication Sign \\
...
\TT{xx}		& \TT{DE} & \TT{TH} & Latin Capital Letter Thorn \\
\TT{xx}		& \TT{DF} & \TT{SS} & Latin Capital Letter Sharp S \\
...
\TT{xx}		& \TT{F0} & \TT{dh} & Latin Small Letter ETH \\
...
\TT{xx}		& \TT{FE} & \TT{th} & Latin Small Letter Thorn \\
