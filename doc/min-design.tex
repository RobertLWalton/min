...
The invalidation of $P_2$ in the above situtations
...
type of a list pointer, e.g., going from an insertable to a writable
list pointer:
...
where the permitted valus of $xx$ and $yy$ are:
...
first argument of {\tt start\_copy}, except the type of the list
pointer can be either downgraded or upgraded,
e.g., going from an ordinary (read-only) list
pointer to an insertable list pointer:
