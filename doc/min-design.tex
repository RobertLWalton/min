...
\begin{enumerate}
\item
$P_2$ points at a removed element or into a sublist that previously
was accessible only through a removed element.

\item
$P_2$ pointed at the same element as $P_1$ and the $P_1$ operation was an
{\tt insert\_before} or {\tt insert\_after}.
\end{enumerate}
...
\verb|min::stub * min::|
	& \MINKEY{stub\_of}\verb| ( min::updatable_list_pointer & lp )|
\LABEL{MIN::STUB_OF_LIST_POINTER_UPDATABLE} \\
\verb|min::stub * min::|
