...
elements.
A read-write or updatable
{\tt min::\EOL updatable\_\EOL list\_\EOL pointer}
...
The functions for using a read-only {\tt min::\EOL list\_\EOL pointer}
are:
...
The {\tt start\_attr} function is analogous except it is given
...
\verb|min::gen min::|
	& \MINKEY{start\_attr}%
	  ...
	  \verb|   min::uns32 index )|
	  \end{tabular}
\LABEL{MIN::START_ATTR_OF_UPDATABLE} \\
\verb|min::gen min::|
	& \MINKEY{start\_copy} \\
	& \verb|    ( min::updatable_list_pointer & lp,| \\
...
\verb|min::uns32 MUP::|
	& \MUPKEY{attr\_size\_of}\verb| ( min::updatable_list_pointer & lp )|
\LABEL{MUP::ATTR_SIZE_OF_LIST_POINTER_OF_UPDATABLE} \\
\verb|min::gen MUP::|
	& \MUPKEY{start\_hash}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::updatable_list_pointer & lp,| \\
...
\verb|min::gen MUP::|
	& \MUPKEY{start\_attr}%
	  ...
	  \verb|   min::uns32 index )| \\
	  \end{tabular}
\LABEL{MUP::START_ATTR_OF_UPDATABLE} \\
\end{tabular}\end{indpar}
