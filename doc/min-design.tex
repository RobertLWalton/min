...
\begin{indpar}\begin{tabular}{r@{}l}
\verb|(constructor) min::| & \MINKEY{static\_gen}\verb|<unsigned size> ( void )|
\LABEL{MIN::STATIC_GEN} \\
\verb|(constructor) min::| & \MINKEY{static\_num\_gen}%
    \verb|<unsigned size> ( void )|
\LABEL{MIN::STATIC_NUM_GEN} \\
\verb|(constructor) min::| & \MINKEY{stack\_gen}\verb|<unsigned size> ( void )|
\LABEL{MIN::STACK_GEN} \\
...
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|min::gen & min::| & \ttkey{operator [ ]} \\
               & \verb|    ( min::static_gen<> & vec, unsigned i )|
\LABEL{MIN::STATIC_GEN_OPERATOR[]} \\
\verb|min::gen & min::| & \ttkey{operator [ ]} \\
               & \verb|    ( min::static_num_gen<> & vec, unsigned i )|
\LABEL{MIN::STATIC_NUM_GEN_OPERATOR[]} \\
\verb|min::gen & min::| & \ttkey{operator [ ]} \\
               & \verb|    ( min::stack_gen<> & vec, unsigned i )|
\LABEL{MIN::STACK_GEN_OPERATOR[]} \\
\verb|min::gen & min::| & \ttkey{operator [ ]} \\
               & \verb|    ( min::stack_num_gen<> & vec, unsigned i )|
...
\verb|void MUP::|
    ...
    & \verb|    ( min::stub * s1, min::gen * p, unsigned n )|
...
\verb|(constructor) MUP::| & \MUPKEY{resize\_body} \\
    & \verb|    ( min::stub * s,| \\
    & \verb|      unsigned new_size, unsigned old_size )|
...
\verb|(constructor) MUP::| & \MUPKEY{resize\_body}\ARGBREAK
    ...
    \verb|      unsigned new_size,|\ARGBREAK
    \verb|      unsigned old_size )|
\LABEL{MUP::RESIZE_BODY} \\
