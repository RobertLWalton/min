...
\verb|bool min::| & \MINKEY{assert\_desired\_value} \verb|= true|
\LABEL{MIN::ASSERT_DESIRED_VALUE} \\
...
If the \TT{value} argument equals \TT{min::\EOL desired\_\EOL value}
and \TT{min::\EOL assert\_\EOL print} is \TT{false}, this function
just returns without doing anything.

If the \TT{value} argument does \underline{not} equal
\TT{min::\EOL desired\_\EOL value}, this function
prints a message and calls \TT{abort()} if
\TT{min::\EOL assert\_\EOL abort} is \TT{true},
else it just throws a \TT{min::\EOL assert\_\EOL exception} without
