...
\verb|const min::uns32 min::| & \MINNBKEY{SUPPRESS\_LAB\_SPACES\_FLAG}
\LABEL{MIN::SUPPRESS_LAB_SPACES_FLAG} \\
\verb|const min::uns32 min::| & \MINNBKEY{SUPPRESS\_OBJ\_SPACES\_FLAG}
\LABEL{MIN::SUPPRESS_OBJ_SPACES_FLAG} \\
