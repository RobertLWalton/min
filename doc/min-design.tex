...
\LABEL{MIN::IS_LETTER} \\
\verb|const min::uns32 min::| & \MINKEY{IS\_PERIOD}
\LABEL{MIN::IS_PERIOD} \\
\end{tabular}\end{indpar}
...
and \minkey{IS\_\EOL PERIOD} flags mark letters (including combining
...
\verb|min::IS_PERIOD                 // skip_if_first|\ARGBREAK
\verb|min::IS_LETTER+min::IS_PERIOD  // in_class_if_all|\ARGBREAK
\verb|0                              // not_in_class_if_any|
\end{tabular}\end{indpar}
