...
Given the index \TT{i = min::Uindex ( c )} of \TT{c}, you can
find out the flags of \TT{c} by using:
...
\begin{indpar}[1em]\begin{tabular}{r@{\hspace*{0.3in}}l}
\TT{min::standard\_str\_classifier} &
\pagref{MIN::STANDARD_STR_CLASSIFIER} \\
\end{tabular}\end{indpar}

TBD

Graphic characters can be given either or both the
\minkey{IS\_LEADING} or \minkey{IS\_TRAILING} flags.
