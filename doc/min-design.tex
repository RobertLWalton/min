...
\begin{center}\begin{tabular}{r@{}l}
\verb|int min::| & \verb|is_number ( min::gen32 v )|
\label{MIN::IS_NUMBER} \\
\verb|int min::| & \verb|is_number ( min::gen64 v )|
\\
\verb|min::gen32 min::| & \verb|new_number_gen32|\REL \verb| ( min::float64 v )|
\label{MIN::NEW_NUMBER_GEN32} \\
\verb|min::gen64 min::| & \verb|new_number_gen64 ( min::float64 v )|
\label{MIN::NEW_NUMBER_GEN64} \\
\verb|min::float64 min::| & \verb|float64_of ( min::gen32 v )|
\label{MIN::FLOAT64_OF_GEN32} \\
\verb|min::float64 min::| & \verb|float64_of ( min::gen64 v )|
\\
\end{tabular}\end{center}%
\minindex{is\_number}%
\minindex{new\_number\_gen32}%
\minindex{new\_number\_gen64}%
\minindex{float64\_of}
...
argument.  For a \verb|min::gen32| argument this function returns
...
Lastly the \verb|min::float64_of| function was documented above
...
\begin{center}\begin{tabular}{r@{}l}
\verb|void min::stub * min::|
	& \verb|new_string|\REL\verb| ( const char * p )|
\label{MIN::NEW_STRING}
\end{tabular}\end{center}%
\minindex{new\_string}
...
\begin{center}\begin{tabular}{r@{}l}
\verb|unsigned | & \verb|strlen ( min::gen32 v )|
\label{STRLEN_OF_GEN32} \\
\verb|unsigned | & \verb|strlen ( min::gen64 v )|
\label{STRLEN_OF_GEN64} \\
\verb|unsigned | & \verb|strhash ( min::gen32 s )|
\label{STRHASH_OF_GEN32} \\
\verb|unsigned | & \verb|strhash ( min::gen64 s )|
\label{STRHASH_OF_GEN64} \\
\verb|min::uns64 | & \verb|strsignature ( min::gen32 s )|
\label{STRSIGNATURE_OF_GEN32} \\
\verb|min::uns64 | & \verb|strsignature ( min::gen64 s )|
\label{STRSIGNATURE_OF_GEN64} \\
\verb|char * | & \verb|strcpy ( char * p, min::gen32 s )|
\label{STRCPY_OF_GEN32} \\
\verb|char * | & \verb|strcpy ( char * p, min::gen64 s )|
\label{STRCPY_OF_GEN64} \\
\verb|char * | & \verb|strncpy ( char * p, min::gen32 s, unsigned n )|
\label{STRNCPY_OF_GEN32} \\
\verb|char * | & \verb|strncpy ( char * p, min::gen64 s, unsigned n )|
...
\begin{center}\begin{tabular}{r@{}l}
\verb|int min::| & \verb|is_string ( min::gen32 v )|
\label{MIN::IS_STRING} \\
\verb|int min::| & \verb|is_string ( min::gen64 v )|
\\
\verb|min::gen32 min::| & \verb|new_string_gen32|\REL \verb| ( const char * p )|
\label{MIN::NEW_STRING_GEN32} \\
\verb|min::gen64 min::| & \verb|new_string_gen64|\REL \verb| ( const char * p )|
\\
\end{tabular}\end{center}%
\minindex{is\_string}%
\minindex{new\_string\_gen32}%
\minindex{new\_string\_gen64}
