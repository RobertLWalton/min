...
are top level lines which should to be separated by \TT{min::\EOL eol}'s.
...
object elements which are printed using \TT{top\_\EOL element\_\EOL format}.
...
and each of these is preceded by executing \TT{min::\EOL indent} to
...
of the line group.  Each line group is ended with \TT{min::\EOL bol}.

An empty paragraph output nothing but
