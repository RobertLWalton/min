...
\TT{min::Uchar} value, which is encoded as
...
as \TT{const min::\EOL Ustring *} values
...
\verb|min::op min::|
    & \MINKEY{punicode}\ARGBREAK
      \verb|( min::unsptr length,|\ARGBREAK
      \verb|  min::ptr<const min::uns32> str )|
...
\ttmindex{number\_format}{in {\tt min::gen\_format}}
    \verb||\\[-5ex]\ARGBREAK
    \verb|  const min::Uchar *       str_prefix;|\ARGBREAK
    \verb|  const min::Uchar *       str_postfix;|\ARGBREAK
    \verb|  const min::Uchar *       str_postfix_name;|\ARGBREAK
    \verb|  const min::Uchar *       str_char_name_prefix;|\ARGBREAK
    \verb|  const min::Uchar *       str_char_name_postfix;|\ARGBREAK
    \verb|  const min::Uchar *       str_concatenator;|\ARGBREAK
...
In above, \TT{U"\ldots"} denotes the ASCII character string \TT{"\ldots"}
converted to a \TT{const min::\EOL Uchar} vector with ending \TT{0} element.
