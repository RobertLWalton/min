...
a 24-bit list auxiliary pointer (32 bit general value only) \\
a 40-bit list auxiliary pointer (64 bit general value only) \\
a 24-bit sublist auxiliary auxiliary pointer (32 bit general value only) \\
a 40-bit sublist auxiliary pointer (64 bit general value only) \\
a 24-bit indirect pair auxiliary pointer (32 bit general value only) \\
a 40-bit indirect pair auxiliary pointer (64 bit general value only) \\
a 24-bit indirect indexed auxiliary pointer (32 bit general value only) \\
a 40-bit indirect indexed auxiliary pointer (64 bit general value only) \\
...
stub pointers, auxiliary pointers, and control codes
