...
\verb|min::gen |
	& \verb|pstype.|\TTKEY{new\_gen} \ARGBREAK
	  \verb|( min::uns32 max_length = 0 )|
\LABEL{PACKED_VEC_NEW_GEN} \\
\verb|min::gen |
	& \verb|pstype.|\TTKEY{new\_gen} \ARGBREAK
	  \verb| ( min::uns32 length, const E * vp )|
...
may not be given and will default to the length.  Or only the maximum
length may be given and the length will default to zero.  Or nothing
may be given and the initial maximum length and length will both
default to zero.
