...
\verb|const min::uns32 min::| & \MINKEY{QUOTE\_SKIP}
\LABEL{MIN::QUOTE_SKIP} \\
\end{tabular}\end{indpar}
...
\begin{indpar}
\begin{tabular}{l@{~~~~~}l}
\ttkey{min::IS\_LEADING}: & \TT{\{}~~~\TT{(}~~~\TT{[}~~~\TT{`}%
			 ~~~\TT{\guillemotleft}%
                         ~~~\TT{\textexclamdown}%
                         ~~~\TT{\textquestiondown} \\
\ttkey{min::IS\_TRAILING}: & \TT{\}}~~~\TT{)}~~~\TT{]}~~~\TT{'}%
			 ~~~\TT{\guillemotright}%
			 ~~~\TT{!}~~~\TT{?}%
			 ~~~\TT{.}~~~\TT{,}~~~\TT{;}~~~\TT{:} \\
\ttkey{min::IS\_MIDDLING}: & other graphic characters \\
\end{tabular}
\end{indpar}
...
(such as LATIN1 \TT{NBSP}),
and \TT{IS\_\EOL OTHER\_\EOL HSPACE} is for other horizontal
space characters that are breaking, like horizontal tab.
...
The next three flags are used in conjuction with printer format
...
The \minkey{QUOTE\_\EOL SUPPRESS}
and \minkey{QUOTE\_\EOL SKIP} flags mark characters that
suppress quoting a string if they appear at the beginning
of the string; specifically, the string is \underline{not}
quoted if it begins with zero or more \TT{QUOTE\_\EOL SKIP}
characters (such at `\TT{.}')
followed by a single \TT{QUOTE\_\EOL SUPPRESS}
character (such as any letter).
See \TT{quote\_\EOL control.in\_\EOL class\_\EOL if\_\EOL first}
and \TT{quote\_\EOL control.skip\_\EOL if\_\EOL first}
on \pagref{IN_CLASS_IF_FIRST}.\label{QUOTE-SUPPRESS}
...
\begin{indpar}
\begin{tabular}{l@{~~~~~}l}
\ttkey{min::CONDITIONAL\_BREAK}: & \TT{-}~~~\TT{\_}~~~\TT{\%} \\
\ttkey{min::QUOTE\_SUPPRESS}: & all letters \\
\ttkey{min::QUOTE\_SKIP}: & \TT{.} \\
\end{tabular}
\end{indpar}
...
there are control characters aside from single spaces in the \TT{ustring}.
The \TT{min::\EOL unicode\_\EOL flags} function returns the flags,
...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|const min::uns32 min::| & \MINKEY{LEADING}
\LABEL{MIN::LEADING_FLAG} \\
\verb|const min::uns32 min::| & \MINKEY{TRAILING}
\LABEL{MIN::TRAILING_FLAG} \\
\end{tabular}\end{indpar}
...
\item Outputting a non-graphic character (e.g., whitespace)
enters the leading state.
This also applies to outputting a picture or name of these characters.
...
\item a string beginning with a non-graphic character
...
printer operation flag is off, and the next thing output is one of:
\begin{enumerate}
\item a string beginning with a maximal trailing graphic substring
\item a string beginning with a non-graphic character
\item the \TT{min::eol} operation or equivalent
\end{enumerate}
\end{enumerate}
...
ASCII and LATIN1 control characters (including horizontal tabs and
single spaces, see \pagref{MIN::IS_CONTROL})
...
\TT{min::\EOL pgen\_\EOL name(v)} is shorthand for
\begin{center}
\tt min::pgen ( v, min::name\_gen\_format )
\end{center}
...
\multicolumn{2}{l}{\tt const min::gen\_format *
                   min::\MINKEY{top\_gen\_format}:}\ARGBREAK
\verb|& min::standard_pgen                    // pgen |\ARGBREAK
\verb|min::long_num_format                    // num_format|\ARGBREAK
\verb|min::quote_first_not_letter_str_format  // str_format|\ARGBREAK
\verb|min::bracket_lab_format                 // lab_format|\ARGBREAK
\verb|min::bracket_special_format             // special_format|\ARGBREAK
\verb|min::exp_obj_format                     // obj_format|\ARGBREAK
\verb|min::id_map_gen_format                  // id_map_format|
\LABEL{MIN::TOP_GEN_FORMAT} \\
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::gen\_format *
                   min::\MINKEY{id\_map\_gen\_format}:}\ARGBREAK
\verb|& min::standard_pgen                    // pgen |\ARGBREAK
\verb|min::long_num_format                    // num_format|\ARGBREAK
\verb|min::quote_first_not_letter_str_format  // str_format|\ARGBREAK
\verb|min::bracket_lab_format                 // lab_format|\ARGBREAK
\verb|min::bracket_special_format             // special_format|\ARGBREAK
\verb|min::id_map_obj_format                  // obj_format|\ARGBREAK
\verb|NULL                                    // id_map_format|
\LABEL{MIN::ID_MAP_GEN_FORMAT} \\
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::gen\_format *
                   min::\MINKEY{name\_gen\_format}:}\ARGBREAK
\verb|& min::standard_pgen                    // pgen |\ARGBREAK
\verb|min::long_num_format                    // num_format|\ARGBREAK
\verb|min::quote_first_not_letter_str_format  // str_format|\ARGBREAK
...
\verb|min::exp_obj_format                     // obj_format|\ARGBREAK
\verb|NULL                                    // id_map_format|
\LABEL{MIN::NAME_GEN_FORMAT} \\
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::gen\_format *
                   min::\MINKEY{never\_quote\_gen\_format}:}\ARGBREAK
\verb|& min::standard_pgen                    // pgen |\ARGBREAK
\verb|min::long_num_format                    // num_format|\ARGBREAK
...
\verb|min::exp_obj_format                     // obj_format|\ARGBREAK
\verb|NULL                                    // id_map_format|
\LABEL{MIN::NEVER_QUOTE_GEN_FORMAT} \\
\end{tabular}\end{indpar}
...
\multicolumn{2}{l}{const min::str\_format *
                   min::\MINKEY{quote\_all\_str\_format}:}\ARGBREAK
\verb|min::quote_all_control                 // quote_control|\ARGBREAK
\verb|min::quote_bracket_format              // bracket_format|\ARGBREAK
\verb|min::graphic_only_display_control      // display_control|
\LABEL{MIN::QUOTE_ALL_STR_FORMAT} \\
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{const min::str\_format *
    min::\MINLKEY{quote\_first\_not\_letter}{\_str\_format}:}\ARGBREAK
\verb|min::quote_first_not_letter_control    // quote_control|\ARGBREAK
\verb|min::quote_bracket_format              // bracket_format|\ARGBREAK
\verb|min::graphic_only_display_control      // display_control|
\LABEL{MIN::QUOTE_FIRST_NOT_LETTER_STR_FORMAT} \\
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{const min::str\_format *
                   min::\MINLKEY{quote\_non\_graphic}{\_str\_format}:}\ARGBREAK
\verb|min::quote_non_graphic_control         // quote_control|\ARGBREAK
\verb|min::quote_bracket_format              // bracket_format|\ARGBREAK
\verb|min::graphic_only_display_control      // display_control|
\LABEL{MIN::QUOTE_NON_GRAPHIC_STR_FORMAT} \\
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt struct
                       min::\MINKEY{str\_classifier}}\ARGBREAK
    \verb|{|\ARGBREAK
    \verb|  min::uns32    in_class_if_first;|%
\ttmindex{in\_class\_if\_first}{in {\tt min::str\_classifier}}\ARGBREAK
    \verb|  min::uns32    skip_if_first;|%
\ttmindex{skip\_if\_first}{in {\tt min::str\_classifier}}\ARGBREAK
    \verb|  min::uns32    in_class_if_all;|%
\ttmindex{in\_class\_if\_all}{in {\tt min::str\_classifier}}\ARGBREAK
    \verb|};|
\LABEL{MIN::QUOTE_CONTROL}
\end{tabular}
\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::str\_classifier
                   min::\MINKEY{quote\_all\_control}:}\ARGBREAK
\verb|0                          // in_class_if_first|\ARGBREAK
\verb|0                          // skip_if_first|\ARGBREAK
\verb|0                          // in_class_if_all|
\LABEL{MIN::QUOTE_ALL_CONTROL}
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::str\_classifier
		   min::\MINLKEY{quote\_first\_not\_letter}{\_control}:}\ARGBREAK
\verb|min::QUOTE_SUPPRESS        // in_class_if_first|\ARGBREAK
\verb|min::QUOTE_SKIP            // skip_if_first|\ARGBREAK
\verb|min::IS_GRAPHIC            // in_class_if_all|
\LABEL{MIN::QUOTE_FIRST_NOT_LETTER_CONTROL}
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::str\_classifier
		   min::\MINKEY{quote\_non\_graphic\_control}:}\ARGBREAK
\verb|min::ALL_CHARS             // in_class_if_first|\ARGBREAK
\verb|0                          // skip_if_first|\ARGBREAK
\verb|min::IS_GRAPHIC            // in_class_if_all|
\LABEL{MIN::QUOTE_NON_GRAPHIC_CONTROL}
\end{tabular}\end{indpar}
...
A \TT{min::quote\_control} value \TT{qc} is
a \TT{min::\EOL str\_\EOL classifier} that causes the string to be quoted
\underline{unless} the string is in the specified class.  Specifically,
a string is in the specified class and is \underline{not} quoted if
\begin{indpar}
(1) \underline{Every} character in the string has some
flag in common with \TT{qc.in\_\EOL class\_\EOL if\_\EOL all}.
If \TT{qc.in\_\EOL class\_\EOL if\_\EOL all} equals
\TT{min::\EOL ALL\_\EOL CHARS}, which has all bits on, this is always
true.
\end{indpar}
\underline{and}
\begin{indpar}
(2) The string is of length \TT{n} and begins with \TT{0} to \TT{n-1}
characters each with a flag in \TT{qc.skip\_\EOL if\_\EOL first},
followed by a single character with a flag in
\TT{qc.in\_\EOL class\_\EOL if\_\EOL first}.\label{IN_CLASS_IF_FIRST}
If \TT{qc.in\_\EOL class\_\EOL if\_\EOL first} equals
\TT{min::\EOL ALL\_\EOL CHARS}, which has all bits on, this is always
true.
\end{indpar}
See the \TT{min::\EOL QUOTE\_\EOL SUPPRESS}
and \TT{min::\EOL QUOTE\_\EOL SKIP} flags on \pagref{QUOTE-SUPPRESS}.
...
\ttmindex{lab\_postfix}{in {\tt min::lab\_format}}\ARGBREAK
    \verb|};|
\LABEL{MIN::LAB_FORMAT}
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::lab\_format
                   min::\MINKEY{name\_lab\_format}:}\ARGBREAK
\verb|NULL                                  // lab_prefix|\ARGBREAK
\verb|NULL                                  // lab_separator|\ARGBREAK
\verb|NULL                                  // lab_postfix|\ARGBREAK
\LABEL{MIN::NAME_LAB_FORMAT}
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::lab\_format
                   min::\MINKEY{bracket\_lab\_format}:}\ARGBREAK
\verb|(const min::ustring *) "\x03\x03" "[: "  // lab_prefix|\ARGBREAK
\verb|NULL                                     // lab_separator|\ARGBREAK
\verb|(const min::ustring *) "\x03\x03" " :]"  // lab_postfix|\ARGBREAK
\LABEL{MIN::BRACKET_LAB_FORMAT}
\end{tabular}\end{indpar}
...
a label format with all \TT{NULL} parts.  However, if
\TT{lf->\EOL lab\_\EOL separator} is \TT{NULL}, it is replaced by
...
\multicolumn{2}{l}{\tt struct
                       min::\MINKEY{obj\_format}}\ARGBREAK
    \verb|{|\ARGBREAK
    \verb|  min::gen_format                      name_format;|%
\ttmindex{name\_format}{in {\tt min::obj\_format}}\ARGBREAK
...
\ttmindex{obj\_braend}{in {\tt min::obj\_format}}\ARGBREAK
    \verb|  const min::ustring *                 obj_separator;|%
\ttmindex{obj\_separator}{in {\tt min::obj\_format}}\ARGBREAK
...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
    \verb|  min::packed_vec_ptr<const char *>    flag_names;|%
\ttmindex{flag\_names}{in {\tt min::obj\_format}}\ARGBREAK
    \verb|};|
\LABEL{MIN::OBJ_FORMAT}
\end{tabular}
\end{indpar}
...
\multicolumn{2}{l}{\tt const min::obj\_format
                   min::\MINKEY{exp\_obj\_format}:}\ARGBREAK
\verb|min::name_gen_format                     // name_format|\ARGBREAK
...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(const min::ustring *) "\x01\x41" "{"    // obj_bra|\ARGBREAK
\verb$(const min::ustring *) "\x01\x01" "|"    // obj_braend$\ARGBREAK
\verb|(const min::ustring *) "\x01\x01" " "    // obj_separator|\ARGBREAK
\verb$(const min::ustring *) "\x01\x01" "|"    // obj_ketbegin$\ARGBREAK
\verb|(const min::ustring *) "\x01\x81" "}"    // obj_ket|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(const min::ustring *) "\x02\x82" ": "   // obj_attrbegin|\ARGBREAK
\verb|(const min::ustring *) "\x01\x81" ":"    // obj_attreol|\ARGBREAK
\verb|(const min::ustring *) "\x02\x02" ", "   // obj_attrsep|\ARGBREAK
\verb|(const min::ustring *) "\x03\x03" "no "  // obj_attrneg|\ARGBREAK
\verb|(const min::ustring *) "\x03\x03" " = "  // obj_attreq|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(const min::ustring *) "\x02\x42" "{*"   // obj_valbegin|\ARGBREAK
\verb|(const min::ustring *) "\x02\x02" ", "   // obj_valsep|\ARGBREAK
\verb|(const min::ustring *) "\x02\x82" "*}"   // obj_valend|\ARGBREAK
\verb|(const min::ustring *) "\x04\x04" " <= " // obj_valreq|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|min::standard_flag_names                 // flag_names|\ARGBREAK
\LABEL{MIN::EXP_OBJ_FORMAT}
\end{tabular}\end{indpar}

\begin{indpar}[1em]
\begin{tabular}{r@{}l}\hspace*{0.1in} \\[-3ex]
\multicolumn{2}{l}{\tt const min::obj\_format
                   min::\MINKEY{id\_map\_obj\_format}:}\ARGBREAK
\verb|min::name_gen_format                     // name_format|\ARGBREAK
\verb|min::top_gen_format                      // element_format|\ARGBREAK
\verb|min::top_gen_format                      // value_format|\ARGBREAK
\end{tabular}
...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|min::standard_flag_names                 // flag_names|\ARGBREAK
\LABEL{MIN::ID_MAP_OBJ_FORMAT}
\end{tabular}\end{indpar}

\begin{indpar}[1em]\begin{tabular}{l}
\verb|min::packed_vec_ptr<const char *> min::|%
    \MINKEY{standard\_\EOL flag\_\EOL names}
\LABEL{MIN::STANDARD_FLAG_NAMES} \\
...
if the \TT{obj\_\EOL bra} member of the object format is \TT{NULL}.
This format is usually used by \TT{flush\_\EOL id\_\EOL map}:
see \itemref{PRINTING-USING-AN-IDENTIFIER-MAP}.

An object is printed in `\mkey{compact format}{for printing object}'
if it is not being printed in isolated line format, if it does not
have any attributes other than \TT{.position} that have multiple
values or flags or reverse attributes (double arrows), and if
\begin{indpar}
It has both \TT{.initiator} and \TT{.terminator} attributes that
are both strings, but no other attributes except possibly a \TT{.separator}
attribute that must be a string and a \TT{.position} attribute that is
unrestricted.
\end{indpar}
or
\begin{indpar}
It has a \TT{.type} attribute that is a name,
but no other attributes except possibly a \TT{.separator} attribute
that must be a string and a \TT{.position} attribute that is unrestricted.
\end{indpar}

An object is printed in `\mkey{embedded line format}{for printing object}'
if it is not being printed in isolated line or compact format and
if the \TT{obj\_\EOL attrbegin} member of the object format is \TT{NULL}.
...
\underline{None} of these values may be \TT{NULL}.

\item[\ttmkey{obj\_empty}{in {\tt min::obj\_format}}]~\\
This is the \TT{min::ustring} printed to represent an
empty object that has no elements and no attributes
other than \TT{.position}.  If \TT{NULL}, it prints
as the empty string of characters, but its not a good
idea for this member to have a \TT{NULL} value unless
perhaps objects are being printed in isolated line format.
...
object elements and attributes in normal format.
In this case \TT{obj\_\EOL bra} followed optionally by the
object's \TT{.type} and attributes followed by
\TT{obj\_\EOL braend} serves as the opening bracket for
the object's list of elements,
and \TT{obj\_\EOL ketbegin}
followed by the object \TT{.type}
followed by \TT{obj\_\EOL ket} serves as the closing bracket
for the object.  If the \TT{.type} is the empty string and there
it is omitted from its beginning position if there are no attributes
and is omitted from its ending position in any case.

If \TT{obj\_bra} is \TT{NULL}, the object is printed
in isolated line format, and not in normal format.
Otherwise, if any of these members other than
\TT{obj\_\EOL bra} are \TT{NULL}, they just print as the
empty string of characters.

\item[\ttmkey{obj\_separator}{in {\tt min::obj\_format}}]~\\
This member serves as the object element separator
when the object is not printed in line format or the object does
not have a \TT{.separator} attribute.

\item[\ttmkey{obj\_attrbegin}{in {\tt min::obj\_format}}]
\item[\ttmkey{obj\_attreol}{in {\tt min::obj\_format}}]\vspace{-2ex}
\item[\ttmkey{obj\_attrsep}{in {\tt min::obj\_format}}]\vspace{-2ex}
\item[\ttmkey{obj\_attrneg}{in {\tt min::obj\_format}}]\vspace{-2ex}
\item[\ttmkey{obj\_attreq}{in {\tt min::obj\_format}}]\vspace{-2ex}~\\
These are the \TT{min::ustring}'s printed to introduce
an object attribute list, separate attributes, indicate
negation of attributes whose value is \TT{FALSE}, and
separator an attribute label from its value.
\TT{Obj\_\EOL attrbegin} is used to begin an attribute
list that is not an indented paragraph, whereas
\TT{obj\_\EOL attreol} is used just before an end-of-line
to begin an attribute list that is an indented
paragraph.  \TT{Obj\_\EOL attrsep} is used to separate
attributes when these are \underline{not} in an indented
paragraph; \TT{obj\_\EOL attreq} separates an attribute
label from the attribute's value; and \TT{obj\_\EOL attrneg}
is the attribute label prefix used to indicate an attribute
with a \TT{FALSE} value.
...
\item[\ttmkey{flag\_names}{in {\tt min::obj\_format}}]~\\
This member is only enabled if it
is not \TT{min::\EOL NULL\_\EOL STUB}.  In this case
\TT{flag\_names[i]} is printed as the representation of
control flag \TT{1 << i} of an attribute.

WARNING: The \TT{flag\_\EOL names} member of a \TT{min::gen\_format} is
\underline{not} locatable by the ACC, and its value must therefore be
stored elsewhere in a locatable variable.  It is expected that values of
\TT{flag\_\EOL names} will never be garbage collected and
...
\verb|min::printer min::| & \MINKEY{print\_obj}\ARGBREAK
    ...
    \verb|  const min::obj_format * obj_format = NULL )|
\LABEL{MIN::PRINT_OBJ} \\
\end{tabular}\end{indpar}

The expression `\TT{printer~<<~min::pgen(v)}' invokes this
function if \TT{v} is an object.  If the \TT{obj\_\EOL format}
argument is \TT{NULL},
\TT{printer->print\_\EOL format.gen\_\EOL format->obj\_\EOL format}
is used as the value of this argument.
...
\LABEL{MIN::UNICODE_COLUMNS} \\
\verb|min::uns32 min::|
    & \MINKEY{unicode\_flags} \ARGBREAK
      \verb|( const min::ustring * p )|
\LABEL{MIN::UNICODE_FLAGS} \\
\verb|const min::Uchar * min::|
...
\verb|min::quote_first_not_letter_str_format  // str_format|\ARGBREAK[0in]
\verb|min::bracket_lab_format                 // lab_format|\ARGBREAK[0in]
\verb|min::bracket_special_format             // special_format|\ARGBREAK[0in]
\verb|min::exp_obj_format                     // obj_format|\ARGBREAK[0in]
\verb|min::id_map_gen_format                  // id_map_format|
\end{TABULAR}
...
\begin{TABULAR}{0.1in}
\multicolumn{2}{l}{const min::str\_format *
    min::\MINLKEY{quote\_first\_not\_letter}{\_str\_format}:}
\LABEL{MIN::QUOTE_FIRST_NOT_LETTER_STR_FORMAT}\ARGBREAK
\verb|min::quote_first_not_letter_control    // quote_control|\ARGBREAK
\verb|min::quote_bracket_format              // bracket_format|\ARGBREAK
\verb|min::graphic_only_display_control      // display_control|
\end{TABULAR}
...
\LABEL{MIN::QUOTE_CONTROL}\ARGBREAK
    \verb|{|\ARGBREAK
    \verb|  min::uns32    in_class_if_first;|%
\ttmindex{in\_class\_if\_first}{in {\tt min::str\_classifier}}\ARGBREAK
    \verb|  min::uns32    skip_if_first;|%
...
\begin{TABULAR}{0.5in}
\multicolumn{2}{l}{\tt const min::str\_classifier
                   min::~{quote\_all\_control}:}
\LABEL{MIN::QUOTE_ALL_CONTROL}\ARGBREAK
\verb|0                          // in_class_if_first|\ARGBREAK
\verb|0                          // skip_if_first|\ARGBREAK
\verb|0                          // in_class_if_all|
\end{TABULAR}
...
\begin{TABULAR}{0.5in}
\multicolumn{2}{l}{\tt const min::str\_classifier
		   min::~{quote\_first\_not\_letter\_control}:}
\LABEL{MIN::QUOTE_FIRST_NOT_LETTER_CONTROL}\ARGBREAK
\verb|min::QUOTE_SUPPRESS        // in_class_if_first|\ARGBREAK
\verb|min::QUOTE_SKIP            // skip_if_first|\ARGBREAK
\verb|min::IS_GRAPHIC            // in_class_if_all|
\end{TABULAR}
...
\begin{TABULAR}{0.5in}
\multicolumn{2}{l}{\tt const min::str\_classifier
		   min::~{quote\_non\_graphic\_control}:}
\LABEL{MIN::QUOTE_NON_GRAPHIC_CONTROL}\ARGBREAK
\verb|min::ALL_CHARS             // in_class_if_first|\ARGBREAK
\verb|0                          // skip_if_first|\ARGBREAK
\verb|min::IS_GRAPHIC            // in_class_if_all|
\end{TABULAR}
