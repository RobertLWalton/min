...
some visible mark.  It is given to all characters except
control characters (including spacing characters)
and unsupported characters, all of which are described below.
