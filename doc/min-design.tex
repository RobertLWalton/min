...
uses the complete attribute name.  If the `{\tt length}' argument
is given, this function uses the longest initial segment of the
...
If the object is reorganized or relocated, the attribute pointers of the object
...
The {\tt get\_flags} function returns these flags in the \verb|min::uns32|
...
The following functions may be used to add one value to the set of values
pointed at:
...
\verb|bool min::| & \MINKEY{test\_flag}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( unsigned n, min::attribute_pointer wap )| \\
    \end{tabular}
\LABEL{MIN::TEST_FLAG} \\
\verb|bool min::| & \MINKEY{test\_flag}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( unsigned n, min::writable_attribute_pointer wap )| \\
    \end{tabular}
