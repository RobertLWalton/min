...
A new preallocated stub can be created by:

\begin{indpar}\begin{tabular}{r@{}l}
\verb|const min::stub * min::| & \MINKEY{new\_preallocated\_stub}
    \verb|( void )|
\LABEL{MIN::NEW_PREALLOCATED_STUB} \\
\end{tabular}\end{indpar}

Each such stub is unique, but has no parts other than its
type.
