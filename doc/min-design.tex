...
See \TT{quote\_\EOL control.unquote\_\EOL if\_\EOL first}
and \TT{quote\_\EOL control.unquote\_\EOL skip}
on \pagref{UNQUOTE_IF_FIRST}.\label{QUOTE-SUPPRESS}
...
\multicolumn{2}{l}{\tt struct
    ...
    \verb|{|\ARGBREAK
    \verb|  min::quote_control    quote_control;|%
...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt struct
                       min::\MINKEY{quote\_control}}\ARGBREAK
    \verb|{|\ARGBREAK
    \verb|  min::uns32    unquote_if_first;|%
\ttmindex{unquote\_if\_first}{in {\tt min::quote\_control}}\ARGBREAK
    \verb|  min::uns32    unquote_skip;|%
\ttmindex{unquote\_skip}{in {\tt min::quote\_control}}\ARGBREAK
    \verb|  min::uns32    unquote_if_none_of;|%
\ttmindex{unquote\_if\_none\_of}{in {\tt min::quote\_control}}\ARGBREAK
    \verb|};|
...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\multicolumn{2}{l}{\tt const min::quote\_control
                   min::\MINKEY{quote\_all\_control}:}\ARGBREAK
\verb|0                          // unquote_if_first|\ARGBREAK
\verb|0                          // unquote_skip|\ARGBREAK
\verb|0                          // unquote_if_none_of|
...
\verb|min::QUOTE_SUPPRESS        // unquote_if_first|\ARGBREAK
\verb|min::QUOTE_SKIP            // unquote_skip|\ARGBREAK
\verb|min::IS_NON_GRAPHIC        // unquote_if_none_of|
...
A \TT{min::quote\_control} value \TT{qc} determines whether a string will
be quoted as follows.  If any character in the string has a character
flag that is in \TT{qc.unquote\_\EOL if\_\EOL none\_\EOL of}, the
string is quoted.  Otherwise if string begins with zero or more characters
each with a flag in \TT{qc.unquote\_\EOL skip}, followed by a single
character with a flag in \TT{qc.unquote\_\EOL if\_\EOL first}, the string
is \underline{not} quoted; otherwise the string is quoted.%
\label{UNQUOTE_IF_FIRST}  See the \TT{min::\EOL QUOTE\_\EOL SUPPRESS}
...
if it is not being printed in isolated line format, and if
\begin{indpar}
