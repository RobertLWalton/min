...
are treated as
the {\tt .initiator} and {\tt .ter\-min\-ator} of an object being
printed, provided that
the object has \underline{neither}
an {\tt .initia\-tor} or a {\tt .ter\-min\-ator} attribute of its own.
...
{\tt BRACKET\_SPECIAL\_FLAG}	& {\tt special\_prefix},
				  {\tt special\_postfix}
\\
{\tt BRACKET\_IMPLICIT\_FLAG}	& {\tt implicit\_initiator},
				  {\tt implicit\_terminator}
...
{\tt 0 <= 0xFFFFFF\,-\,i
       < min::\EOL standard\_\EOL special\_\EOL names\_\EOL size}, then
