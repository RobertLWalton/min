...
\verb|bool min::| & \MINKEY{has\_single\_attr}\ARGBREAK
     \verb|( min::obj_vec_ptr & vp,|\ARGBREAK
     \verb|  bool include_attr_vec = false )|
\LABEL{MIN::HAS_SINGLE_ATTR_OF_VEC_PTR} \\
\end{tabular}\end{indpar}
...
The \TT{min::has\_single\_attr} function is the optimized
equivalent of getting all the information that the 3-argument
\TT{min::attr\_info\_of} gets and then returning \TT{true} iff any
\TT{value\_\EOL count} is greater than zero.
