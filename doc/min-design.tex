...
The elements of a label may be accessed sequentially using a label
pointer:

\begin{center}\begin{tabular}{r@{}l}
(constructor)~\verb|MUP::|
	& \MUPKEY{label\_pointer}\verb| ( min::stub * s )|
\LABEL{MUP::LABEL_POINTER_OF_STUB} \\
(constructor)~\verb|MUP::|
	& \MUPKEY{label\_pointer}\verb| ( min::gen obj )|
\LABEL{MUP::LABEL_POINTER_OF_GEN} \\
\verb|min::gen min::|
	& \MINKEY{current}\verb| ( min::label_pointer & lp )|
\LABEL{MIN::CURRENT_OF_LABEL_POINTER} \\
\verb|min::gen min::|
	& \MINKEY{next}\verb| ( min::label_pointer & lp )|
\LABEL{MIN::NEXT_OF_LABEL_POINTER} \\
\end{tabular}\end{center}
...
any of the other functions.  Then the {\tt MUP::hash\_table\_size\_of}
and {\tt MUP::attribute\_vector\_size\_of} functions can be called to
...
\begin{center}\begin{tabular}{r@{}l}
\verb|void MUP::|
	& \MUPKEY{start}\verb| ( min::writable_list_pointer & lp )|
\LABEL{MUP::START_LIST_POINTER_OF_WRITABLE} \\
\verb|unsigned MUP::|
	& \MUPKEY{hash\_size\_of}\verb| ( min::writable_list_pointer & lp )|
\LABEL{MUP::HASH_SIZE_OF_LIST_POINTER_OF_WRITABLE} \\[1ex]
\verb|unsigned MUP::|
	& \MUPKEY{vector\_size\_of}\verb| ( min::writable_list_pointer & lp )|
\LABEL{MUP::VECTOR_SIZE_OF_LIST_POINTER_OF_WRITABLE} \\
\verb|min::gen MUP::|
	& \MUPKEY{start\_hash}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::writable_list_pointer & lp,| \\
	  \verb|   unsigned index )| \\
	  \end{tabular}
\LABEL{MUP::START_HASH_OF_WRITABLE} \\
\verb|min::gen MUP::|
	& \MUPKEY{start\_vector}%
	  \begin{tabular}[t]{@{}l@{}}
	  \verb| ( min::writable_list_pointer & lp,| \\
	  \verb|   unsigned index )| \\
	  \end{tabular}
\LABEL{MUP::START_VECTOR_OF_WRITABLE} \\
\end{tabular}\end{center}
...
\begin{center}\begin{tabular}{r@{}l}
\verb|min::stub * min::|
	& \MINKEY{stub\_of}\verb| ( min::list_pointer & lp )|
\LABEL{MIN::STUB_OF_LIST_POINTER} \\
\verb|min::stub * min::|
	& \MINKEY{stub\_of}\verb| ( min::writable_list_pointer & lp )|
\LABEL{MIN::STUB_OF_LIST_POINTER_WRITABLE} \\
\verb|min::stub * min::|
	& \MINKEY{stub\_of}\verb| ( min::insertable_list_pointer & lp )|
\LABEL{MIN::STUB_OF_LIST_POINTER_INSERTABLE} \\
\end{tabular}\end{center}
...
attribute vector index, or it the {\em attribute-name}
...
An attribute that does not exist is equivalent to an attribute with
an empty value set and all zero flags.  A reverse attribute name that does
not exist for a particular attribute is equivalent to that name with an
empty value set.
...
\verb|bool min::| & \MINKEY{test\_flag}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( unsigned n, min::attribute_pointer ap )| \\
    \end{tabular}
\LABEL{MIN::TEST_FLAG} \\
\verb|bool min::| & \MINKEY{test\_flag}%
    \begin{tabular}[t]{@{}l@{}}
