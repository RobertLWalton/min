...
\begin{center}\begin{tabular}{r@{}l}
\verb|min::uns64 mup::| & \MUPKEY{short\_string\_of}\verb| ( min::stub * s )|
...
\LABEL{STRCPY} \\
\verb|char * | & \TTKEY{strncpy}\verb| ( char * p, min::stub * s, unsigned n )|
\LABEL{STRNCPY} \\
\end{tabular}\end{center}
...
Gen32 Value Protected Function Declarations:
...
Gen32 Value Unprotected Function Declarations:
...
Gen64 Value Protected Function Declarations:
...
Gen64 Value Unprotected Function Declarations:
...
Number Stub Protected Function Declarations:
...
Number Stub Unprotected Function Declarations:
...
String Stub Protected Function Declarations:
...
\verb|char * | & \TTKEY{strncpy}\ARGBREAK
	\verb| ( char * p, min::stub * s,|\ARGBREAK\verb|   unsigned n )|
\LABEL{STRNCPY} \\[1ex]
...
String Stub Unprotected Function Declarations:
