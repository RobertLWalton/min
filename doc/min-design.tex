...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|min::trailing_always_semicolon_space_pstring|\ARGBREAK
\verb|                                         // obj_line_sep|
\end{tabular}
...
In \mkey{paragraph compact format}{of printed object}, where there are
are no attributes other than \TT{.type}
and attributes with a \TT{hide\_\EOL flag},
...
\verb|min::trailing_always_semicolon_space_pstring|\ARGBREAK[0in]
\verb|                                         // obj_line_sep|
\end{TABULAR}
