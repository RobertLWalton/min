...
{\tt min::\EOL packed\_\EOL vec\EHLARG::\EOL xxxptr} members,
...
\begin{enumerate}
\item Construction of a datum of the type
...
header elements described below are given values.
\item
...
and {\tt max\_\EOL length} members of the header.
