...
\verb|const min::uns32 | & \verb|prtr->length|
\LABEL{MIN::PRINTER_LENGTH} \\
\verb|const min::uns32 | & \verb|prtr->line|
\LABEL{MIN::PRINTER_LINE} \\
\verb|min::printer_state | & \verb|prtr->state|
\LABEL{MIN::PRINTER_STATE} \\
\verb|min::printer_state | & \verb|prtr->saved_state|
\LABEL{MIN::PRINTER_SAVED_STATE} \\
\verb|std::ostream * | & \verb|prtr->ostream|
...
\verb|const min::uns32 min::| & \MINKEY{GRAPHIC\_FLAG}
\LABEL{MIN::GRAPHIC_FLAG} \\
\verb|const min::uns32 min::| & \MINKEY{DISPLAY\_LINEFEED\_FLAG}
\LABEL{MIN::DISPLAY_LINEFEED_FLAG} \\
\verb|const min::uns32 min::| & \MINKEY{HEX\_FLAG}
\LABEL{MIN::HEX_FLAG} \\
\verb|const min::uns32 min::| & \MINKEY{IGNORE\_LINE\_LENGTH\_FLAG}
