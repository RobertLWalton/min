...
These are some of the printer {\tt print\_EOL format.flags} used to print
...
pushes the new line break stack element,
resets {\tt line\_\EOL break.indent} to equal the printer
{\tt column}.  In addition, a non-empty line break stack modifies break point
...
implied {\tt min::\EOL indent} operation if the line break stack element
