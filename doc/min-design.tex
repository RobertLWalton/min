...
{\tt MUP::\EOL acc\_\EOL write\_\EOL update} must be called when
members of these types are written.  There is
...
{\tt \ldots\_ref(q) =} calls.  Accidentally writing {\tt q->g}
and {\tt q->p} is prevented by making the {\tt g} and {\tt p}
members `{\tt const}'.
