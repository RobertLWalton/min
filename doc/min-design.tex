...
{\tt min::\EOL OBJ\_\EOL PUBLIC} flag as already been set.
...
the vector pointer version of {\tt min::reorganize}
...
\verb|min::OBJ_PRIVATE| nor the \verb|min::OBJ_PUBLIC| flags are set.
