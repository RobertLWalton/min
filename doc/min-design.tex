...
\begin{center}\begin{tabular}{r@{}l}
\verb|min::float64 | & \MINKEY{float\_of\COMPACT}\verb| ( min::stub * s )|
\LABEL{FLOAT_OF} \\
\verb|min::float64 MUP::| & \MUPKEY{float\_of\COMPACT}\verb| ( min::stub * s )|
\LABEL{MUP::FLOAT_OF}
\end{tabular}\end{center}
...
\begin{center}\begin{tabular}{r@{}l}
\verb|void MUP::|
    & \MUPKEY{set\_float\_of\COMPACT}\verb| ( min::stub * s, min::float64 f )|
...
The following functions read or write the stub value and stub control parts
of a stub:
...
\LABEL{MUP::FLOAT_OF} \\
\verb|void MUP::|
    & \MUPKEY{set\_float\_of\COMPACT}\ARGBREAK
