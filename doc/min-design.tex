...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|min::suppress_matrix printer->|
    & \TTMKEY{\EOL suppress\_\EOL matrix}{in {\tt min::printer}}
\LABEL{MIN::PRINTER_SUPPRESS_MATRIX} \\
\end{tabular}\end{indpar}
...
\vspace{-2ex}~
\item[\ttmkey{suppress\_matrix}{in {\tt min::printer}}]%
\vspace{-2ex}~\\
