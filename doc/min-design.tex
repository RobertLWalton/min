...
attribute values.  A double arrow is a joined pair of map entries in different
objects.  The part of the hash table that maps small
...
small integers.  The vector stores attribute values for attributes whose
...
long objects when required.  Conversion in the other direction, and compaction
