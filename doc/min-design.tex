...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|void min::|
    & \MINKEY{init\_spool\_lines}\verb| ( min::file & file,|\\&
             {\tt ~~~~~~~~~~~~~~}\verb|   min::uns32 spool_lines )|
...
\verb|void min::|
    & \MINKEY{init\_output\_file}\ARGBREAK
          \verb| ( min::file & file,|\ARGBREAK
...
\verb|void min::|
    & \MINKEY{init\_output\_printer}\ARGBREAK
          \verb| ( min::file & file,|\ARGBREAK
...
\verb|void min::|
    & \MINKEY{init\_input\_named\_file}\ARGBREAK
	  ...
	  \verb|   min::printer & err )|
\LABEL{MIN::INIT_INPUT_FILE_OF_NAMED_FILE} \\
\verb|void min::|
...
The number of buffer {\tt char} elements that have already been
...
of a file.  If there are more complete (i.e., terminated)
lines, then when new lines are output
...
If {\tt spool\_EOL lines~==~min::\EOL ALL\_\EOL lines},
all lines in the file are retained.
...
there are elements not yet output.  Non-NUL elements are output
...
\verb|min::uns32 min::|
    & \MINKEY{line}\verb| ( min::file & file,|\\&{\tt ~~~}
	           \verb|   min::uns32 line )|
...
\verb|void min::|
    & \MINKEY{end\_line}\verb| ( min::file & file,|\\&{\tt ~~~~~~~}
...
\verb|min::uns32 min::|
    & \MINKEY{rewind}\verb| ( min::file & file,|\\&{\tt ~~~~~~}
                     \verb|   min::uns32 offset = 0 )|
