...
(\itemref{STRING-CLASSIFIERS})
and the 
\TT{marking\_\EOL type} string classifier of the object format,
\pagref{MARKING_TYPE}.
...
\ttmindex{paragraph\_type}{in {\tt min::obj\_format}}\ARGBREAK
    \verb|  min::ustring                         obj_paragraph_begin;|%
\ttmindex{obj\_paragraph\_begin}{in {\tt min::obj\_format}}\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
    \verb|  min::packed_vec_ptr<min::ustring>    attr_flag_names;|%
...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(min::ustring) "\x02\x02" "{}"           // obj_empty|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(min::ustring) "\x01\x01" "{"    // obj_bra|\ARGBREAK
\verb$(min::ustring) "\x01\x01" "|"    // obj_braend$\ARGBREAK
\verb$(min::ustring) "\x01\x01" "|"    // obj_ketbegin$\ARGBREAK
\verb|(min::ustring) "\x01\x01" "}"    // obj_ket|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(min::ustring) "\x01\x00" " "    // obj_sep|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(min::ustring) "\x82\x00" ": "   // obj_attrbegin|\ARGBREAK
\verb|(min::ustring) "\x02\x00" ", "   // obj_attrsep|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(min::ustring) "\x81\x01" ":"    // obj_attreol|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(min::ustring) "\x03\x00" "no "  // obj_attrneg|\ARGBREAK
\verb|(min::ustring) "\x03\x00" " = "  // obj_attreq|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(min::ustring) "\x03\x00" "{* "  // obj_valbegin|\ARGBREAK
\verb|(min::ustring) "\x02\x00" ", "   // obj_valsep|\ARGBREAK
\verb|(min::ustring) "\x03\x00" " *}"  // obj_valend|\ARGBREAK
\verb|(min::ustring) "\x04\x00" " <= " // obj_valreq|\ARGBREAK
\end{tabular}
...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb$(min::ustring) "\x04\x04" "{||}" // obj_empty$\ARGBREAK
\end{tabular}
...
\verb|(min::ustring) "\x81\x01" ";"    // obj_line_sep|\ARGBREAK
\end{tabular}

\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|min::NONE()                              // paragraph_type|\ARGBREAK
\verb|(min::ustring) "\x81\x01" ":"    // obj_paragraph_begin|\ARGBREAK
\end{tabular}
...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|(min::ustring) "\x80\x00" ""     // obj_sep|\ARGBREAK
\end{tabular}
