...
See {\tt line\_\EOL break.line\_\EOL length}
...
An adjustment that extends beyond the printer
{\tt line\_\EOL break.line\_\EOL length} will format badly if
...
{\tt line\_\EOL break.indent}.  The operation
...
It does this because it assumes the disabled element was used and
printing the text bracketed by the {\tt min::\EOL save\_\EOL line\_\EOL break}
that pushed the element and the {\tt min::\EOL restore\_\EOL line\_\EOL break}
that is being executed was preceded by an actual line break and should be
...
The {\tt min::save\_indent} operation is intended to be use just
after printing the header of a list, and
the {\tt min::\EOL restore\_\EOL indent}
...
{\tt min::\EOL restore\_\EOL line\_\EOL break} without any implied
{\tt min::\EOL indent}, a {\tt min::\EOL eol},
and a {\tt min::\EOL restore\_\EOL print\_\EOL format}.
Note that print format flags in effect just before {\tt min::\EOL eom}
