...
\verb|unsigned min::|
    & \MINKEY{hash\_table\_size\_of}\verb| ( min::long_obj * lo )|
...
\verb|unsigned min::|
    & \MINKEY{attribute\_vector\_size\_of}\verb| ( min::long_obj * lo )|
...
\verb|unsigned min::|
    & \MINKEY{auxiliary\_area\_size\_of}\verb| ( min::long_obj * lo )|
...
\verb|unsigned min::|
    & \MINKEY{unused\_area\_size\_of}\verb| ( min::long_obj * lo )|
...
\verb|unsigned min::| & \MINKEY{total\_size\_of}\verb| ( min::long_obj * lo )|
...
\verb|unsigned min::|
	& \MINKEY{hash\_table\_of}\verb| ( min::long_obj * lo )|
...
\verb|unsigned min::|
	& \MINKEY{attribute\_vector\_of}\verb| ( min::long_obj * lo )|
