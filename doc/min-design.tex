...
dependent fashion.  
The \TT{min::\EOL attr\_\EOL info\_\EOL of} function
gets information about each
...
the \TT{min::\EOL attr\_\EOL info\_\EOL of} function, and this should be used
to retry with a larger `\TT{out}' vector.

The implementation dependent order of the \TT{attr\_info}
values returned by \TT{min::\EOL attr\_\EOL info\_\EOL of} may change if attribute
...
vector returned by \TT{min::\EOL attr\_\EOL info\_\EOL of}.
The \TT{min::\EOL compare} function, \pagref{MIN::COMPARE},
is used to determine the ordering of names.

The \TT{min::\EOL reverse\_attr\_info\_of}
