...
\begin{enumerate}
\item If either the preceeding or following items do not have the
...
Sequence of printer items can be represented by `\skey{printer string}s':
...
The \TT{min::print\_item} function prints a single printer item
...
Here \TT{str\_format->str\_classifier}
...
\pagref{STRING-CLASSIFIERS} for details on string classifiers.
