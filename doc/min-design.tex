...
(constructor)~\verb|MUP::|
	& \MUPKEY{attr\_pointer}\verb| ( min::vec_pointer & vp )|
...
\verb|min::unsptr min::| & \MINKEY{get\_attrs}\ARGBREAK
    ...
    \verb|   min::attr_pointer ap )|
\LABEL{MIN::GET_ATTRS} \\
\verb|void min::| & \MINKEY{rewind\_attrs}\ARGBREAK
    \verb| ( min::attr_pointer ap )|
\LABEL{MIN::REWIND_ATTRS} \\
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|MUP::|
	& \MUPKEY{updatable\_attr\_pointer}\ARGBREAK
	  \verb| ( min::updatable_vec_pointer & vp )|
...
\verb|min::gen min::|
	& \MINKEY{locatei}\ARGBREAK
	  \verb| ( min::updatable_attr_pointer & ap,|\ARGBREAK
	  \verb|   int name )|
\LABEL{MIN::LOCATEI_ATTR_OF_UPDATABLE_ATTR} \\
\verb|min::gen min::|
	& \MINKEY{locate}\ARGBREAK
	  \verb| ( min::updatable_attr_pointer & ap,|\ARGBREAK
	  \verb|   min::unsptr & length, min::gen name )|
...
\verb|min::unsptr min::| & \MINKEY{count}\ARGBREAK
    \verb| ( min::updatable_attr_pointer ap )|
\LABEL{MIN::COUNT_OF_UPDATABLE_ATTR} \\
...
\verb|unsigned min::| & \MINKEY{count\_flags}\ARGBREAK
    \verb| ( min::updatable_attr_pointer ap )|
\LABEL{MIN::COUNT_FLAGS_OF_UPDATABLE_ATTR} \\
...
\verb|void min::| & \MINKEY{rewind\_attrs}\ARGBREAK
    \verb| ( min::updatable_attr_pointer ap )|
\LABEL{MIN::REWIND_ATTRS_OF_UPDATABLE} \\
\verb|min::unsptr min::| & \MINKEY{get\_reverse\_attrs}\ARGBREAK
    \verb| ( min::gen * out, min::unsptr n,|\ARGBREAK
    \verb|   min::updatable_attr_pointer ap )|
...
value set have a single value.  This function replaces this
single value, returning the previous value.
...
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|MUP::|
	& \MUPKEY{insertable\_attr\_pointer}\ARGBREAK
	  \verb| ( min::insertable_vec_pointer & vp )|
...
\verb|min::gen min::|
	& \MINKEY{locatei}\ARGBREAK
	  \verb| ( min::insertable_attr_pointer & ap,|\ARGBREAK
	  \verb|   int name )|
\LABEL{MIN::LOCATEI_ATTR_OF_INSERTABLE_ATTR} \\
\verb|min::gen min::|
	& \MINKEY{locate}\ARGBREAK
	  \verb| ( min::insertable_attr_pointer & ap,|\ARGBREAK
	  \verb|   min::unsptr & length, min::gen name )|
...
\verb|min::unsptr min::| & \MINKEY{count}\ARGBREAK
    \verb| ( min::insertable_attr_pointer ap )|
\LABEL{MIN::COUNT_OF_INSERTABLE_ATTR} \\
\verb|min::unsptr min::| & \MINKEY{get}\ARGBREAK
    \verb| ( min::gen * out, min::unsptr n,|\ARGBREAK 
    \verb|   min::insertable_attr_pointer ap )|
...
\verb|unsigned min::| & \MINKEY{count\_flags}\ARGBREAK
    \verb| ( min::insertable_attr_pointer ap )|
\LABEL{MIN::COUNT_FLAGS_OF_INSERTABLE_ATTR} \\
\verb|unsigned min::| & \MINKEY{get\_flags}\ARGBREAK
    \verb| ( min::gen * out, unsigned n,|\ARGBREAK
    \verb|   min::insertable_attr_pointer ap )|
...
\verb|void min::| & \MINKEY{rewind\_attrs}\ARGBREAK
    \verb| ( min::insertable_attr_pointer ap )|
\LABEL{MIN::REWIND_ATTRS_OF_INSERTABLE} \\
\verb|min::unsptr min::| & \MINKEY{get\_reverse\_attrs}\ARGBREAK
    \verb| ( min::gen * out, min::unsptr n,|\ARGBREAK
    \verb|   min::insertable_attr_pointer ap )|
