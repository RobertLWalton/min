...
~\\
{\tt EXPAND\_HT} causes the character \TT{'\textbackslash t'}
...
If {\tt EXPAND\_HT} is \underline{off} and the character \TT{'\textbackslash t'}
...
is executed at the very end of each {\tt min::\EOL eol} operation.
