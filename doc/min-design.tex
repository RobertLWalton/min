...
\verb|min::unsptr min::|
    & \MINKEY{utf8\_to\_unicode}\ARGBREAK
      \verb|( min::uns32 * & u, const min::uns32 * endu,|\ARGBREAK
      \verb|  const char * & s, const char * ends )|
\LABEL{MIN::UTF8_STR_TO_UNICODE_STR} \\
\verb|min::unsptr min::|
    & \MINKEY{unicode\_to\_utf8}\ARGBREAK
      \verb| ( char * & s, const char * ends,|\ARGBREAK
      \verb|   const min::uns32 * & u,|\ARGBREAK
      \verb|   const min::uns32 * endu )|
...
the number of string elements, \TT{min::uns32}'s or \TT{char}'s respectively,
written.
...
\ttmindex{number\_format}{in {\tt min::gen\_format}}
    ...
    \verb|  const min::char_names *  str_char_names;|\ARGBREAK
    \verb|  const min::char_flags *  str_char_flags;|\ARGBREAK
    \verb|  const char *             str_char_name_prefix;|\ARGBREAK
    \verb|  const char *             str_char_name_postfix;|\ARGBREAK
    \verb|  const char *             str_concatenator;|\ARGBREAK
...
\multicolumn{2}{l}{\tt const min::gen\_format
    ...
    \verb|  & min::default_char_names,|\ARGBREAK
    \verb|  & min::default_char_flags,|\ARGBREAK
    \verb|  "<",">",             // str_char_name_prefix/postfix|\ARGBREAK
    \verb|  " # ",8,             // str_concatenate/str_max_length|\ARGBREAK
