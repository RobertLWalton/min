...
because they change not only
the size of the object but also the offset of some elements within the object.
The names of such functions are marked with the subscript
\subsmkey{S}{of function}.
...
by the {\tt min::\EOL publish\REL} function
(\pagref{MIN::PUBLISH}).
...
must not contain any call to a resizing (\RESIZE) function
(\pagref{RESIZING-FUNCTIONS}), aside from
...
\verb|void min::| & \MINKEY{resize\REL}%
    ...
    \end{tabular}
\LABEL{MIN::RESIZE_UNUSED} \\
\verb|void min::| & \MINKEY{expand\REL}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( min::gen object,| \\
    \verb|   min::unsptr unused_size )| \\
    \end{tabular}
...
\begin{TABULAR}{1.2in}
\verb|void min::| & \MINKEY{reorganize\REL}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( min::gen object,| \\
    \verb|   min::unsptr hash_size,| \\
    \verb|   min::unsptr variable_size,| \\
...
\begin{TABULAR}{1.2in}
\verb|void min::| & \MINKEY{compact\REL}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( min::gen object,| \\
    \verb|   min::unsptr variable_size,| \\
    \verb|   min::unsptr unused_size,| \\
...
\verb|void min::| & \MINKEY{compact\REL}%
    ...
    \end{tabular}
\LABEL{MIN::COMPACT} \\
\verb|void min::| & \MINKEY{publish\REL}%
    \begin{tabular}[t]{@{}l@{}}
    \verb| ( min::gen object )| \\
    \end{tabular}
\LABEL{MIN::PUBLISH} \\
