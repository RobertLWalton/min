...
\LABEL{MIN::IS_MARK} \\
\verb|const min::uns32 min::| & \MINKEY{IS\_BRACKET}
\LABEL{MIN::IS_BRACKET} \\
\end{tabular}\end{indpar}
...
The \minkey{IS\_\EOL BRACKET} flag is given to all brackets, such as
\TT{(~)}, \TT{`~'}, and \TT{\guillemotleft~\guillemotright}, and is
used to force quoting of strings containing bracket characters.
...
other that the \TT{IS\_\EOL BRACKET} characters,
...
\verb|0                              // skip_if_first|\ARGBREAK
\verb|min::IS_GRAPHIC                // in_class_if_all|\ARGBREAK
\verb|min::IS_BRACKET                // not_in_class_if_any|
\end{tabular}\end{indpar}
...
\verb|min::IS_MARK+min::IS_BRACKET   // in_class_if_first|\ARGBREAK
\verb|0                              // skip_if_first|\ARGBREAK
\verb|min::IS_MARK+min::IS_BRACKET   // in_class_if_all|\ARGBREAK
\verb|0                              // not_in_class_if_any|
\end{tabular}\end{indpar}
...
\LABEL{MIN::STR_CLASSIFIER}\ARGBREAK
    \verb|{|\ARGBREAK
    \verb|  min::uns32    in_class_if_first;|\ARGBREAK
    \verb|  min::uns32    skip_if_first;|\ARGBREAK
    \verb|  min::uns32    in_class_if_all;|\ARGBREAK
    \verb|  min::uns32    not_in_class_if_any;|\ARGBREAK
    \verb|};|
\end{TABULAR}
