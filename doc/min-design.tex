...
This is done by using the high order 16 bits of the value as a subtype
code, and using two values of this subtype code that would be
...
properties of {\tt min::float64}, and in some implementations
is {\tt typedef}'ed to {\tt min::float64}, and so {\tt min::\EOL gen64}
