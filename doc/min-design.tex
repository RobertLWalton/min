...
to give \TT{v} an ID number {\em <id>} and then outputs `\TT{@}{\em <id>}'.
...
prints \TT{id\_map[ID]} in a lines of the form:
\begin{center}
\TT{@}{\em <ID>} \TT{=} {\em value}
\end{center}
...
\TT{printer->\EOL print\_\EOL format.id\_\EOL map\_\EOL gen\_\EOL format}
\end{center}
If the \TT{id\_map} argument is not given or \TT{min::\EOL NULL\_\EOL STUB},
...
In any case it returns the `\TT{printer}' argument as its value.
