...
It is sometimes useful to divide UNICODE characters into classes.
The function
...
returns the class of the UNICODE character {\tt c}.  The classes of all
ASCII characters are the characters themselves, e.g., the class of
...
The classes of non-ASCII UNICODE characters are:
\begin{center}
\begin{tabular}{l@{~is the class of~}l}
\verb|'L'| & non-ASCII characters considered to be letters by C++ \\
\verb|'D'| & combining diacritical marks \\
\verb|'U'| & any character not otherwise assigned a class \\
\end{tabular}
\end{center}
...
\item[\ttmkey{special\_separator}{in {\tt min::printer\_format}}]\vspace{-2ex}
