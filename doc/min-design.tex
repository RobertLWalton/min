...
The \verb|min::|\MINKEY{gen} type is defined as a C++ class that
...
that has a body.  In addition there is a general body pointer type
that points at any type an element in any body associated with any stub:
