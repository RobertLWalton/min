...
referenced by both is the position of the empty phrase in the file.
...
\verb|(constructor) min::| & \MINKEY{pline\_numbers}\ARGBREAK
    \verb| ( min::file file,|\ARGBREAK
    \verb|   min::phrase_position & phrase_position )|
\LABEL{MIN::PLINE_NUMBERS_OF_PHRASE_POSITION} \\
\end{tabular}\end{indpar}

which uses {\tt phrase\_\EOL position.begin.line} and
which uses {\tt phrase\_\EOL position.end.line} as
line numbers.
...
\verb|min::uns32 min::|
    & \MINKEY{print\_\EOL phrase\_\EOL lines\REL}\ARGBREAK
      \verb| ( min::printer printer,|\ARGBREAK
      \verb|   min::file file,|\ARGBREAK
      \verb|   const min::phrase_position & phrase_position,|\ARGBREAK
