...
\LABEL{MIN::PACKED_STRUCT_POINTER_TYPEDEF} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
...
\begin{indpar}[0.1in]\begin{tabular}{r@{}l}
(constructor)~\verb|min::|
	& \MINKEY{packed\_struct\_updatable\_pointer\SARG} \verb|psup|
	  \verb| ( min::gen v )|
...
\LABEL{MIN::PACKED_STRUCT_UPDATABLE_POINTER_TYPEDEF} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
...
The names {\tt min::\EOL packed\_\EOL struct<S>::\EOL pointer} and
{\tt min::\EOL packed\_\EOL struct<S>::\EOL updatable\_\EOL pointer} are
...
{\tt min::\EOL packed\_\EOL struct\_\EOL pointer<S>} and
{\tt min::\EOL packed\_\EOL struct\_\EOL updatable\_\EOL pointer<S>} in
these circumstances.
