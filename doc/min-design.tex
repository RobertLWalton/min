...
\ttmindex{lab\_format}{in {\tt min::gen\_format}}\ARGBREAK
    \verb|  const min::specials_format *  specials_format;|%
\ttmindex{specials\_format}{in {\tt min::gen\_format}}\ARGBREAK
...
\verb|min::bracket_specials_format            // specials_format|\ARGBREAK
...
\verb|min::name_lab_format                    // lab_format|\ARGBREAK
\verb|min::name_specials_format               // specials_format|\ARGBREAK
\verb|min::exp_obj_format                     // obj_format|\ARGBREAK
\verb|TBD                                     // id_map_format|
