...
(constructor)~\verb|min::|
	& \MINKEY{packed\_struct\SARG::pointer} \verb|psp| \ARGBREAK
	  \verb| ( min::stub * s )|
\LABEL{MIN::PACKED_STRUCT_POINTER_OF_STUB} \\
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::packed_struct<S>::pointer & psp,|\ARGBREAK
	  \verb|   min::gen v )|
\LABEL{MIN::INITIALIZE_PACKED_STRUCT_POINTER_OF_GEN} \\
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::packed_struct<S>::pointer & psp,|\ARGBREAK
	  \verb|   min::stub * s )|
\LABEL{MIN::INITIALIZE_PACKED_STRUCT_POINTER_OF_STUB} \\
\verb|void min::|
	& \MINKEY{deinitialize}\ARGBREAK
	  \verb| ( min::packed_struct<S>::pointer & psp )|
\LABEL{MIN::DEINITIALIZE_PACKED_STRUCT_POINTER} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
(constructor)~\verb|min::|
...
(constructor)~\verb|min::|
	& \MINKEY{packed\_struct\SARG::updatable\_pointer} \verb|psup|\ARGBREAK
	  \verb| ( min::stub * s )|
\LABEL{MIN::PACKED_STRUCT_UPDATABLE_POINTER_OF_STUB} \\
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::packed_struct<S>|\ARGBREAK
	  \verb|      ::updatable_pointer & psp,|\ARGBREAK
	  \verb|   min::gen v )|
\LABEL{MIN::INITIALIZE_PACKED_STRUCT_UPDATABLE_POINTER_OF_GEN} \\
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::packed_struct<S>|\ARGBREAK
	  \verb|      ::updatable_pointer & psp,|\ARGBREAK
	  \verb|   min::stub * s )|
\LABEL{MIN::INITIALIZE_PACKED_STRUCT_UPDATABLE_POINTER_OF_STUB} \\
\verb|void min::|
	& \MINKEY{deinitialize}\ARGBREAK
	  \verb| ( min::packed_struct<S>|\ARGBREAK
	  \verb|      ::updatable_pointer & psp )|
\LABEL{MIN::DEINITIALIZE_PACKED_STRUCT_UPDATABLE_POINTER} \\
\end{tabular}\end{indpar}
\begin{indpar}\begin{tabular}{r@{}l}
\verb|const S * | & \verb|psp|
\LABEL{MIN::PACKED_STRUCT_POINTER_CONVERSION} \\
\verb|S * | & \verb|psup|
\LABEL{MIN::PACKED_STRUCT_UPDATABLE_POINTER_CONVERSION} \\
\end{tabular}\end{indpar}

This last means that \verb|psp| is
implicitly convertable to a `\verb|const S *|' pointer and
\verb|psup| is implicitly convertable to a `\verb|S *|' pointer.
However these C `\verb|S *|' pointers, since they point at a body,
can change whenever a relocating function (\pagref{RELOCATING-FUNCTIONS})
is called, so they should generally \underline{not} be saved in a variable,
but should only be used inside a single statement.

The {\tt min::initialize} functions can be used to change the
packed structure a pointer points at, and the {\tt min::deinitialize}
functions can be used to set a packed structure pointer so it is not
...
\verb|void min::|
	& \MINKEY{initialize}\ARGBREAK
	  \verb| ( min::packed_vec<H,E>::pointer & psp,|\ARGBREAK
	  \verb|   min::gen v )|
...
\verb|void min::|
	& \MINKEY{deinitialize}\ARGBREAK
	  \verb| ( min::packed_vec<H,E>::pointer & psp )|
