...
The following function returns the index of the first occurence
of its first argument \verb|v1| as a subsequence of its second
argument \verb|v2|, or returns \verb|-1| if there is no such
occurence.  The arguments must be labels or atoms, with an atom
being equivalent to a length {\tt 1} label whose sole element
is the atom.
