...
\verb|unsigned min::| & \MINKEY{lab\_of}%
    \verb| ( min::gen * p, unsigned n, const min::stub * s )|
\LABEL{MIN::LAB_OF} \\
\verb|unsigned min::| & \MINKEY{lab\_of}%
...
to the body vector is returned by the following protected functions:
...
\LABEL{MIN::TOTAL_SIZE_OF_VEC_POINTER} \\[1ex]
...
\end{center}
Note that all these accesses are read-only.
...
\subsubsection{Unprotected Object Vector Level}
