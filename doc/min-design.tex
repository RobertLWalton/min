...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|std::ostream & |
    & \TTOMKEY{<<}{\LT\LT\RESIZE}{of {\tt std::ostream \&}}\ARGBREAK
      \verb|( std::ostream & out,|\ARGBREAK
      \verb|  const min::op & op )|
...
{\tt min::\EOL gen\_\EOL format} value pointed at by {\tt f}.
If {\tt f} is {\tt NULL},
{\tt printer->\EOL print\_\EOL format.gen\_\EOL format}
is used instead.  If that is also {\tt NULL},
...
\verb|struct min::| & \MINKEY{gen\_format}\ARGBREAK
    ...
    \verb|};|
\ttmindex{flags}{in {\tt min::gen\_format}}
...
\ttmindex{pstub}{in {\tt min::gen\_format}}
