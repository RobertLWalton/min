...
type \verb|T| of the raw vector element.

\newcommand{\TARG}{{\tt \LESSTHAN T\GREATERTHAN}}
...
\verb|T min::|
	& \ttkey{operator [ ]}\ARGBREAK
	  \verb| ( min::raw_vec_pointer<T> & rvp,|\ARGBREAK
	  \verb|   min::unsptr i )|
\LABEL{MIN::RAW_VEC_POINTER[]} \\
\verb|min::unsptr min::|
	& \MINKEY{length\_of}\ARGBREAK
	  \verb| ( min::raw_vec_pointer<T> & rvp )|
...
\verb|T & min::|
	& \ttkey{operator [ ]}\ARGBREAK
	  \verb| ( min::updatable_raw_vec_pointer<T> & rvp,|\ARGBREAK
	  \verb|   min::unsptr i )|
\LABEL{MIN::UPDATABLE_RAW_VEC_POINTER[]} \\
\verb|min::unsptr min::|
	& \MINKEY{length\_of}\ARGBREAK
	  \verb| ( min::updatable_raw_vec_pointer<T> & rvp )|
...
\verb|T & min::|
	& \ttkey{operator [ ]}\ARGBREAK
	  \verb| ( min::insertable_raw_vec_pointer<T> & rvp,|\ARGBREAK
	  \verb|   min::unsptr i )|
\LABEL{MIN::INSERTABLE_RAW_VEC_POINTER[]} \\
\verb|min::unsptr min::|
	& \MINKEY{length\_of}\ARGBREAK
	  \verb| ( min::insertable_raw_vec_pointer<T> & rvp )|
...
\multicolumn{2}{l}{\tt const min::raw\_vec\_type\_info} \\
\verb|min|
	& {\tt ::insertable\_raw\_vec\_pointer\TARG} \\
	& {\tt ::}\ttkey{type\_info}
\LABEL{MIN::TYPE_INFO_OF_INSERTABLE_RAW_VEC_POINTER} \\
\end{tabular}\end{indpar}
