...
interrupts during the entire algorithm.
...
and set the body pointer of the second stub to
\TT{MACC::\EOL deallocated\_\EOL body}.

\item[Step \ref{PREALLOCATED-ACC-WRITE-UPDATE}] Leave as is,
except do not permit the garbage collector to interrupt.

\item[Step \ref{PREALLOCATED-SET-TYPE}] Copy the type from
the second stub the preallocated stub, and then set the
