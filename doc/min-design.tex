...
range errors.  If given out-of-range arguments, their results are undefined.
...
\verb|unsigned min::| & \MINKEY{lablen}%
    \verb| ( min::gen * const p, unsigned n )|
\LABEL{MIN::LABLEN_OF_GEN_VECTOR} \\
\end{tabular}\end{center}
...
\verb|unsigned min::| & \MINKEY{lablen}\verb| ( min::gen v )|
\LABEL{MIN::LABLEN_OF_GEN} \\
\verb|unsigned min::| & \MINKEY{lablen}\ARGBREAK
    \verb| ( min::gen * const p, unsigned n )|
\LABEL{MIN::LABLEN_OF_GEN_VECTOR} \\[1ex]
