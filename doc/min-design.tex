...
\ARGBREAK
    \verb|  min::packed_vec_ptr<min::gen>        expr_ok_attr;|%
\ttmindex{expr\_ok\_attr}{in {\tt min::obj\_format}}\ARGBREAK
...
\multicolumn{2}{l}{\tt const min::obj\_format
                   min::\MINKEY{name\_obj\_format}:}\ARGBREAK
