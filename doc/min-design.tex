...
{\tt prtr->parameters} contains parameters that control
the printing process:

TBD

{\tt prtr->\EOL para\-meters.line\_\EOL length}
limits the length of lines and forces insertion of line breaks into
output.  {\tt prtr->\EOL parameters.indent} is the indentation of
any continuation lines after inserted line breaks.
{\tt prtr->\EOL parameters.format} controls the printing of
{\tt min::gen} values by the {\tt min::pgen} function described
below.
{\tt prtr->\EOL parameters.flags} contains the following flags that
...
The {\tt min::\EOL ASCII\_\EOL FLAG}
