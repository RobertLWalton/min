...
an \TT{min::\EOL id\_\EOL map} preceeds the definition of the
...
\begin{indpar}\begin{tabular}{r@{}l}
\verb|void min::| & \MINKEY{stub\_swap}\ARGBREAK
...
This is most often done when one of the stubs has the
...
accomodate \TT{id}.  If the stub body has not yet been input,
a stub of \minkey{PREALLOCATED}\LABEL{MIN::PREALLOCATED} type can be created,
which has no body, and whose stub type is changed when the stub later
acquires a body.
See \itemref{SWAPPING-STUBS}.
