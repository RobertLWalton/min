...
and in these implementation {\tt int} is incorrectly convertable to
{\tt min::gen} by a C++ implicit conversion.  As a consequence of this
the {\tt locatei} function must have a differenent name from the
{\tt locate} function.}
...
{\tt locate} and perhaps {\tt locate\_reverse} functions, or by
