...
The first line number is \TT{0}.  Reset when the file is rewound.
...
Or when \TT{end\_offset <= next\_offset} and
\TT{min::\EOL next\_\EOL line} returns \TT{NO\_\EOL LINE},
the offset in the \TT{buffer} of the first character of the
...
Reset when the file is rewound.
...
\TT{line\_\EOL index->\EOL length} is reset
