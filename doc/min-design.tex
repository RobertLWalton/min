...
with \TT{p.s = NULL\_STUB} and \TT{ps.offset = 0}.
...
stub of \minkey{PTR}\label{MIN::PTR} type
...
\TT{min::\EOL UNDEFINED()}.  Otherwise a
\TT{min::\EOL ptr<min::gen>} pointer is returned that will cause
a segment fault if it is used.
