...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|const min::uns32 prtr| & \TTARMKEY{length}{of {\tt min::printer}}
\LABEL{MIN::PRINTER_LENGTH} \\
\verb|const min::uns32 prtr| & \TTARMKEY{line}{of {\tt min::printer}}
\LABEL{MIN::PRINTER_LINE} \\
\verb|const min::uns32 prtr| & \TTARMKEY{column}{of {\tt min::printer}}
\LABEL{MIN::PRINTER_COLUMN} \\
\verb|const min::uns32 prtr| & \TTARMKEY{line\_offset}{of {\tt min::printer}}
\LABEL{MIN::PRINTER_LINE_OFFSET} \\
\verb|const min::uns32 prtr| & \TTARMKEY{break\_offset}{of {\tt min::printer}}
\LABEL{MIN::PRINTER_BREAK_OFFSET} \\
\verb|min::printer_parameters prtr|
    & \TTARMKEY{parameters}{of {\tt min::printer}}
\LABEL{MIN::PRINTER_PARAMETERS} \\
\verb|min::printer_parameters prtr|
    & \TTARMKEY{saved\_parameters}{of {\tt min::printer}}
\LABEL{MIN::PRINTER_SAVED_PARAMETERS} \\
\verb|std::ostream * prtr| & \TTARMKEY{ostream}{of {\tt min::printer}}
...
\verb|const min::uns32 min::| & \MINNBKEY{HEXADECIMAL\_FLAG}
\LABEL{MIN::HEXADECIMAL_FLAG} \\
...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|struct min::| & \MINKEY{default\_printer\_parameters}\verb| =|\ARGBREAK
    \verb|{|\ARGBREAK
...
\begin{indpar}[1em]\begin{tabular}{r@{}l}
\verb|const min::printer_item min::| & \MINKEY{hexadecimal}
\LABEL{MIN::HEXADECIMAL} \\
\verb|const min::printer_item min::| & \MINKEY{nohexadecimal}
\LABEL{MIN::NOHEXADECIMAL} \\
