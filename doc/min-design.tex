...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|min::standard_str_classifier             // marking_type|\ARGBREAK
...
\vspace{-4ex}\begin{tabular}{r@{}l}\hspace*{0.1in}\ARGBREAK
\verb|min::null_str_classifier                 // marking_type|\ARGBREAK
...
on compact format objects printed as per the \TT{marking\_\EOL type}
...
These are the \TT{min::pstring}'s printed to indicate
