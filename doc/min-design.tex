...
if their first argument has the value {\tt min::\EOL NULL\_\EOL STUB},
and rewind the file otherwise,
resetting {\tt next\_\EOL line\_\EOL number}
and {\tt next\_\EOL offset} to {\tt 0} and emptying
{\tt line\_\EOL index} if it exists.
...
and {\tt min::\EOL init\_\EOL ostream} just
...
and {\tt file\_\EOL name} to {\tt min::\EOL MISSING()}.  For example,
given the code:
\begin{indpar}\begin{verbatim}
...
to the file buffer, as for example:\label{WRITING-FILE-BUFFER}
\begin{indpar}\begin{verbatim}
...
The\label{LINE-INDEX-LENGTH}
required conditions are determined in part
