...
`{\tt prtr1<<prtr2}' copies the not-previously-copied
...
for printing {\tt min::gen} numbers cast to {\tt min::\EOL float64} values.
...
The {\tt special\_\EOL {pre,post}fix} members are printed just before and
