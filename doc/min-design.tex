...
\\[1ex]
\emkey{double-arrow-map-sublist} ::=
...
{\em double-arrow-map-sublist}.  This last maps {\em reverse-attribute-names}
to sets of values.

A {\em hash-list} is simply a list of alternating {\em attribute-names}
and {\em attribute-descriptors}.
The long form of an {\em attribute-descriptors} is an
{\em attribute-sublist} that gives a list of flags, a list of {\em values},
and an optional {\em double-arrow-map-sublist}.  If the
...
in the {\em hash-list} for the object's hash table entry which index
equals the hash of the {\em attribute-name} modulo the length of the
hash table.

A {\em double-arrow-map-sublist} is 
...
flags or {\em double-arrow-map-sublists}.
...
\emkey{node-sublist}
    ...
    ::= & {\em flag-set}
	  {\em value}$\,^\star$ \\
    $|$ & {\em child-sublist}
	  {\em double-arrow-map-sublist-option}
	  {\em flag-set}
	  {\em value}$\,^\star$ \\
    \end{tabular}
\\[1ex]
...
and optional {\em double-arrow-map-sublist} which are associated
...
{\em attribute-name-component}/{\em node-descriptor} pairs for
...
If a nodes's {\em attribute-name-component} is an integer in the legal
...
node's {\em attribute-name-component} modulo the length of the hash table.
...
{\em child-sublist} nor the {\em double-arrow-map-sublist} can be present.
Note that to avoid ambiguity it is not permitted to omit the
{\em child-sublist} without also omitting
the {\em double-arrow-map-sublist}.  Except for these details
...
not allowed.  The {\em double-arrow-map-sublist} structure is exactly
the same.
