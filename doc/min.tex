...
where \verb/(| |)/ represent implied parentheses, and
the \verb|"+"| is a quoted \verb|+| to indicate it cannot
be interpreted as an operator.
This is the cooked representation of the set of objects
...
curly brackets (\verb|{ }|) are used to change to
a format suitable for code, so that
...
Parsing proceeds from the innermost expression to the outtermost.
