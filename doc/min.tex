...
\TT{"}			& \TT{\&quot;} \\
\TT{<NBSP>}		& \TT{\&nbsp;} \\
{\bf \textendash}        & \TT{\&ndash;} & en dash \\
{\bf \textemdash}	& \TT{\&mdash;} & em dash \\
{\bf \textcopyright}	& \TT{\&copy;} \\
{\bf \textregistered}	& \TT{\&reg;} \\
{\bf \texttrademark}	& \TT{\&trade;} \\
{$\mathbf \approx$}	& \TT{\&asymp;} \\
{$\mathbf \neq$}	& \TT{\&ne;} \\
{\bf \pounds}		& \TT{\&pound;} \\
{\bf \texteuro}		& \TT{\&euro;} \\
{\bf \textdegree}	& \TT{\&deg;} & degree \\
\end{tabular}
