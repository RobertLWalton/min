...
\\\hspace*{1in}
	{\em arrow-label} {\em arrow-label-terminator}
...
\\\hspace*{1in}
	{\em arrow-label-initiator} {\em arrow-label}
...
It is possible to place \skey{arrow flag}s on arrows by putting flag characters
before or after the \verb|:| that follows or precedes an arrow label.
The following is the same as the above example except that flags
have been added to some of the arrows:
...
In the picture the arrow flags have been added as subscripts on the arrow
labels, and in the text the flags have been added before of after the
\verb|:| that follows or precedes the arrow label.

Several arrows sourced at the same object may have the same attribute
label.  An example of this is, in which object \verb|##1| sources two
arrows labeled \verb|child|, is:
...
attribute names, attribute flags, and attribute values, in place of
arrows, arrow labels, arrow flags, and arrow targets.
...
The \skey{attribute flag}s\index{flag!attribute} are just the flags
of this arrow.
