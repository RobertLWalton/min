...
found in the given object or fram.
...
\key{call operation} using the function abstraction that was
in this list is performed.  Specifically:
\begin{indpar}[0.5em]
A new evaluation context, called the \key{function context}, is pushed
into the evaluation stack.  The context previous to this in the stack,
...
The call operation executes evaluation steps until the function context
terminates.

Then the call operation sets the caller context output value list
and {\tt throw}
flag to equal the function context output value list and {\tt throw} flag,
and pops the function context and its frame from their stacks.
...
Set the input value list to empty.
\end{indpar}
