...
{\tt caller} components are copied from the {\tt caller} context of the
function context.  The {\tt expression} of the argument evaluation
context is set to the next argument of the caller context expression,
and the {\tt current evaluator} of the argument evaluation context
is set to the {\tt initial evaluator} of that context.
