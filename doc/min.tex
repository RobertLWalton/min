...
\TT{min::bom} should be output before any part of the message is
output.  Then the indent can be set to any point in the message
...
of the message by the \TT{min::\EOL eom}.  Here \TT{min::bol} is used
only because one might not be sure whether the printer was at
the beginning of a line when the error message is printed.
