...
\verb|const char *| & \TT{line\_group\_class}
                    & \pagref{LINE_FORMAT_LINE_GROUP_CLASS} \\
\verb|const char *| & \TT{line\_class} & \pagref{LINE_FORMAT_LINE_CLASS} \\
...
\verb|     const char * |
	& \TTMKEY{line\_group\_class}{in {\tt min::line\_format}} \\
\verb|     const char * |
...
\verb|"MIN-LINE-GROUP",          // line_group_class|\ARGBREAK
...
\TT{printer->\EOL print\_\EOL format\EOL .line\_\EOL format->\EOL
blank\_\EOL line} is printed instead of
...
immediately followed by\label{LINE_FORMAT_END_OF_FILE}
\TT{printer->\EOL print\_\EOL format\EOL .line\_\EOL format->\EOL
end\_\EOL of\_\EOL file}, all on one line,
