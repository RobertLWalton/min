...
The lines of an input file are typically saved an can be accessed
by the \TT{min::line} (\pagref{MIN::LINE_OF_FILE})
function.  A position in such a file is defined as the point
...
phrase position vector, the phrase position
