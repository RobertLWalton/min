...
// Date:	Fri May 12 13:30:10 EDT 2023
//
...
#   endif
    ...
    MIN_CHECK ( min::is_attr_legal ( min::MISSING() ) );
    MIN_CHECK ( min::is_attr_legal
                   ( min::new_num_gen ( -1 ) ) );
    MIN_CHECK ( ! min::is_attr_legal ( min::NONE() ) );
    MIN_CHECK
        ( ! min::is_attr_legal ( min::LIST_END() ) );
    MIN_CHECK ( min::is_list_legal ( min::MISSING() ) );
    MIN_CHECK ( min::is_list_legal
                   ( min::new_num_gen ( -1 ) ) );
    MIN_CHECK
        ( min::is_list_legal ( min::NONE() ) );
    MIN_CHECK
        ( ! min::is_list_legal ( min::LIST_END() ) );
...
void test_object_attribute_short_cuts ( void )
{
    ...
    min::set ( obj, yourattr, min::NONE() );
    MIN_CHECK
      ( 0 == min::get ( results, 10, obj, yourattr ) );
...
void test_object_printing ( void )
{
    ...
    min::find_or_add ( printer->id_map, obj8 );
    printer << min::eol << min::flush_id_map;
